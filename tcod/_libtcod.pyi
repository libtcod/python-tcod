...
class _lib:
    @staticmethod
    def NoiseGetSample(noise: Any, xyzw: Any, /) -> Any:
    ...
    def SDL_AcquireGPUSwapchainTexture(
        ...
        """unsigned char SDL_AcquireGPUSwapchainTexture(SDL_GPUCommandBuffer *command_buffer, SDL_Window *window, SDL_GPUTexture **swapchain_texture, Uint32 *swapchain_texture_width, Uint32 *swapchain_texture_height)"""
    ...
    def SDL_AddEventWatch(filter: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_AddEventWatch(SDL_EventFilter filter, void *userdata)"""
    ...
    def SDL_AddGamepadMappingsFromIO(src: Any, closeio: bool, /) -> int:
        """int SDL_AddGamepadMappingsFromIO(SDL_IOStream *src, unsigned char closeio)"""

    @staticmethod
    def SDL_AddHintCallback(name: Any, callback: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_AddHintCallback(const char *name, SDL_HintCallback callback, void *userdata)"""

    @staticmethod
    def SDL_AddSurfaceAlternateImage(surface: Any, image: Any, /) -> bool:
        """unsigned char SDL_AddSurfaceAlternateImage(SDL_Surface *surface, SDL_Surface *image)"""
    ...
    def SDL_AddVulkanRenderSemaphores(
        ...
        """unsigned char SDL_AddVulkanRenderSemaphores(SDL_Renderer *renderer, Uint32 wait_stage_mask, Sint64 wait_semaphore, Sint64 signal_semaphore)"""
    ...
    def SDL_AudioDevicePaused(devid: Any, /) -> bool:
        """unsigned char SDL_AudioDevicePaused(SDL_AudioDeviceID devid)"""

    @staticmethod
    def SDL_AudioStreamDevicePaused(stream: Any, /) -> bool:
        """unsigned char SDL_AudioStreamDevicePaused(SDL_AudioStream *stream)"""
    ...
    def SDL_BindAudioStream(devid: Any, stream: Any, /) -> bool:
        """unsigned char SDL_BindAudioStream(SDL_AudioDeviceID devid, SDL_AudioStream *stream)"""

    @staticmethod
    def SDL_BindAudioStreams(devid: Any, streams: Any, num_streams: int, /) -> bool:
        """unsigned char SDL_BindAudioStreams(SDL_AudioDeviceID devid, SDL_AudioStream * const *streams, int num_streams)"""
    ...
    def SDL_BlitSurface(src: Any, srcrect: Any, dst: Any, dstrect: Any, /) -> bool:
        """unsigned char SDL_BlitSurface(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, const SDL_Rect *dstrect)"""
    ...
    def SDL_BlitSurface9Grid(
        ...
        """unsigned char SDL_BlitSurface9Grid(SDL_Surface *src, const SDL_Rect *srcrect, int left_width, int right_width, int top_height, int bottom_height, float scale, SDL_ScaleMode scaleMode, SDL_Surface *dst, const SDL_Rect *dstrect)"""

    @staticmethod
    def SDL_BlitSurfaceScaled(src: Any, srcrect: Any, dst: Any, dstrect: Any, scaleMode: Any, /) -> bool:
        """unsigned char SDL_BlitSurfaceScaled(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, const SDL_Rect *dstrect, SDL_ScaleMode scaleMode)"""

    @staticmethod
    def SDL_BlitSurfaceTiled(src: Any, srcrect: Any, dst: Any, dstrect: Any, /) -> bool:
        """unsigned char SDL_BlitSurfaceTiled(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, const SDL_Rect *dstrect)"""

    @staticmethod
    def SDL_BlitSurfaceTiledWithScale(
        src: Any, srcrect: Any, scale: Any, scaleMode: Any, dst: Any, dstrect: Any, /
    ) -> bool:
        """unsigned char SDL_BlitSurfaceTiledWithScale(SDL_Surface *src, const SDL_Rect *srcrect, float scale, SDL_ScaleMode scaleMode, SDL_Surface *dst, const SDL_Rect *dstrect)"""

    @staticmethod
    def SDL_BlitSurfaceUnchecked(src: Any, srcrect: Any, dst: Any, dstrect: Any, /) -> bool:
        """unsigned char SDL_BlitSurfaceUnchecked(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, const SDL_Rect *dstrect)"""

    @staticmethod
    def SDL_BlitSurfaceUncheckedScaled(src: Any, srcrect: Any, dst: Any, dstrect: Any, scaleMode: Any, /) -> bool:
        """unsigned char SDL_BlitSurfaceUncheckedScaled(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, const SDL_Rect *dstrect, SDL_ScaleMode scaleMode)"""
    ...
    def SDL_CancelGPUCommandBuffer(command_buffer: Any, /) -> bool:
        """unsigned char SDL_CancelGPUCommandBuffer(SDL_GPUCommandBuffer *command_buffer)"""

    @staticmethod
    def SDL_CaptureMouse(enabled: bool, /) -> bool:
        """unsigned char SDL_CaptureMouse(unsigned char enabled)"""

    @staticmethod
    def SDL_ClaimWindowForGPUDevice(device: Any, window: Any, /) -> bool:
        """unsigned char SDL_ClaimWindowForGPUDevice(SDL_GPUDevice *device, SDL_Window *window)"""
    ...
    def SDL_ClearAudioStream(stream: Any, /) -> bool:
        """unsigned char SDL_ClearAudioStream(SDL_AudioStream *stream)"""

    @staticmethod
    def SDL_ClearClipboardData() -> bool:
        """unsigned char SDL_ClearClipboardData(void)"""

    @staticmethod
    def SDL_ClearComposition(window: Any, /) -> bool:
        """unsigned char SDL_ClearComposition(SDL_Window *window)"""

    @staticmethod
    def SDL_ClearError() -> bool:
        """unsigned char SDL_ClearError(void)"""

    @staticmethod
    def SDL_ClearProperty(props: Any, name: Any, /) -> bool:
        """unsigned char SDL_ClearProperty(SDL_PropertiesID props, const char *name)"""

    @staticmethod
    def SDL_ClearSurface(surface: Any, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_ClearSurface(SDL_Surface *surface, float r, float g, float b, float a)"""
    ...
    def SDL_CloseAsyncIO(asyncio: Any, flush: bool, queue: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_CloseAsyncIO(SDL_AsyncIO *asyncio, unsigned char flush, SDL_AsyncIOQueue *queue, void *userdata)"""
    ...
    def SDL_CloseIO(context: Any, /) -> bool:
        """unsigned char SDL_CloseIO(SDL_IOStream *context)"""
    ...
    def SDL_CloseStorage(storage: Any, /) -> bool:
        """unsigned char SDL_CloseStorage(SDL_Storage *storage)"""

    @staticmethod
    def SDL_CompareAndSwapAtomicInt(a: Any, oldval: int, newval: int, /) -> bool:
        """unsigned char SDL_CompareAndSwapAtomicInt(SDL_AtomicInt *a, int oldval, int newval)"""

    @staticmethod
    def SDL_CompareAndSwapAtomicPointer(a: Any, oldval: Any, newval: Any, /) -> bool:
        """unsigned char SDL_CompareAndSwapAtomicPointer(void **a, void *oldval, void *newval)"""

    @staticmethod
    def SDL_CompareAndSwapAtomicU32(a: Any, oldval: Any, newval: Any, /) -> bool:
        """unsigned char SDL_CompareAndSwapAtomicU32(SDL_AtomicU32 *a, Uint32 oldval, Uint32 newval)"""
    ...
    def SDL_ConvertAudioSamples(
        ...
        """unsigned char SDL_ConvertAudioSamples(const SDL_AudioSpec *src_spec, const Uint8 *src_data, int src_len, const SDL_AudioSpec *dst_spec, Uint8 **dst_data, int *dst_len)"""

    @staticmethod
    def SDL_ConvertEventToRenderCoordinates(renderer: Any, event: Any, /) -> bool:
        """unsigned char SDL_ConvertEventToRenderCoordinates(SDL_Renderer *renderer, SDL_Event *event)"""

    @staticmethod
    def SDL_ConvertPixels(
        width: int, height: int, src_format: Any, src: Any, src_pitch: int, dst_format: Any, dst: Any, dst_pitch: int, /
    ) -> bool:
        """unsigned char SDL_ConvertPixels(int width, int height, SDL_PixelFormat src_format, const void *src, int src_pitch, SDL_PixelFormat dst_format, void *dst, int dst_pitch)"""
    ...
    def SDL_ConvertPixelsAndColorspace(
        ...
        """unsigned char SDL_ConvertPixelsAndColorspace(int width, int height, SDL_PixelFormat src_format, SDL_Colorspace src_colorspace, SDL_PropertiesID src_properties, const void *src, int src_pitch, SDL_PixelFormat dst_format, SDL_Colorspace dst_colorspace, SDL_PropertiesID dst_properties, void *dst, int dst_pitch)"""
    ...
    def SDL_CopyFile(oldpath: Any, newpath: Any, /) -> bool:
        """unsigned char SDL_CopyFile(const char *oldpath, const char *newpath)"""

    @staticmethod
    def SDL_CopyGPUBufferToBuffer(copy_pass: Any, source: Any, destination: Any, size: Any, cycle: bool, /) -> None:
        """void SDL_CopyGPUBufferToBuffer(SDL_GPUCopyPass *copy_pass, const SDL_GPUBufferLocation *source, const SDL_GPUBufferLocation *destination, Uint32 size, unsigned char cycle)"""

    @staticmethod
    def SDL_CopyGPUTextureToTexture(
        copy_pass: Any, source: Any, destination: Any, w: Any, h: Any, d: Any, cycle: bool, /
    ) -> None:
        """void SDL_CopyGPUTextureToTexture(SDL_GPUCopyPass *copy_pass, const SDL_GPUTextureLocation *source, const SDL_GPUTextureLocation *destination, Uint32 w, Uint32 h, Uint32 d, unsigned char cycle)"""

    @staticmethod
    def SDL_CopyProperties(src: Any, dst: Any, /) -> bool:
        """unsigned char SDL_CopyProperties(SDL_PropertiesID src, SDL_PropertiesID dst)"""

    @staticmethod
    def SDL_CopyStorageFile(storage: Any, oldpath: Any, newpath: Any, /) -> bool:
        """unsigned char SDL_CopyStorageFile(SDL_Storage *storage, const char *oldpath, const char *newpath)"""
    ...
    def SDL_CreateDirectory(path: Any, /) -> bool:
        """unsigned char SDL_CreateDirectory(const char *path)"""

    @staticmethod
    def SDL_CreateEnvironment(populated: bool, /) -> Any:
        """SDL_Environment *SDL_CreateEnvironment(unsigned char populated)"""
    ...
    def SDL_CreateGPUDevice(format_flags: Any, debug_mode: bool, name: Any, /) -> Any:
        """SDL_GPUDevice *SDL_CreateGPUDevice(SDL_GPUShaderFormat format_flags, unsigned char debug_mode, const char *name)"""
    ...
    def SDL_CreateProcess(args: Any, pipe_stdio: bool, /) -> Any:
        """SDL_Process *SDL_CreateProcess(const char * const *args, unsigned char pipe_stdio)"""
    ...
    def SDL_CreateStorageDirectory(storage: Any, path: Any, /) -> bool:
        """unsigned char SDL_CreateStorageDirectory(SDL_Storage *storage, const char *path)"""
    ...
    def SDL_CreateWindowAndRenderer(
        ...
        """unsigned char SDL_CreateWindowAndRenderer(const char *title, int width, int height, SDL_WindowFlags window_flags, SDL_Window **window, SDL_Renderer **renderer)"""
    ...
    def SDL_CursorVisible() -> bool:
        """unsigned char SDL_CursorVisible(void)"""

    @staticmethod
    def SDL_DateTimeToTime(dt: Any, ticks: Any, /) -> bool:
        """unsigned char SDL_DateTimeToTime(const SDL_DateTime *dt, SDL_Time *ticks)"""
    ...
    def SDL_DestroyWindowSurface(window: Any, /) -> bool:
        """unsigned char SDL_DestroyWindowSurface(SDL_Window *window)"""
    ...
    def SDL_DetachVirtualJoystick(instance_id: Any, /) -> bool:
        """unsigned char SDL_DetachVirtualJoystick(SDL_JoystickID instance_id)"""

    @staticmethod
    def SDL_DisableScreenSaver() -> bool:
        """unsigned char SDL_DisableScreenSaver(void)"""
    ...
    def SDL_EnableScreenSaver() -> bool:
        """unsigned char SDL_EnableScreenSaver(void)"""
    ...
    def SDL_EnumerateDirectory(path: Any, callback: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_EnumerateDirectory(const char *path, SDL_EnumerateDirectoryCallback callback, void *userdata)"""

    @staticmethod
    def SDL_EnumerateProperties(props: Any, callback: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_EnumerateProperties(SDL_PropertiesID props, SDL_EnumeratePropertiesCallback callback, void *userdata)"""

    @staticmethod
    def SDL_EnumerateStorageDirectory(storage: Any, path: Any, callback: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_EnumerateStorageDirectory(SDL_Storage *storage, const char *path, SDL_EnumerateDirectoryCallback callback, void *userdata)"""

    @staticmethod
    def SDL_EventEnabled(type: Any, /) -> bool:
        """unsigned char SDL_EventEnabled(Uint32 type)"""

    @staticmethod
    def SDL_FillSurfaceRect(dst: Any, rect: Any, color: Any, /) -> bool:
        """unsigned char SDL_FillSurfaceRect(SDL_Surface *dst, const SDL_Rect *rect, Uint32 color)"""

    @staticmethod
    def SDL_FillSurfaceRects(dst: Any, rects: Any, count: int, color: Any, /) -> bool:
        """unsigned char SDL_FillSurfaceRects(SDL_Surface *dst, const SDL_Rect *rects, int count, Uint32 color)"""
    ...
    def SDL_FlashWindow(window: Any, operation: Any, /) -> bool:
        """unsigned char SDL_FlashWindow(SDL_Window *window, SDL_FlashOperation operation)"""

    @staticmethod
    def SDL_FlipSurface(surface: Any, flip: Any, /) -> bool:
        """unsigned char SDL_FlipSurface(SDL_Surface *surface, SDL_FlipMode flip)"""

    @staticmethod
    def SDL_FlushAudioStream(stream: Any, /) -> bool:
        """unsigned char SDL_FlushAudioStream(SDL_AudioStream *stream)"""
    ...
    def SDL_FlushIO(context: Any, /) -> bool:
        """unsigned char SDL_FlushIO(SDL_IOStream *context)"""

    @staticmethod
    def SDL_FlushRenderer(renderer: Any, /) -> bool:
        """unsigned char SDL_FlushRenderer(SDL_Renderer *renderer)"""
    ...
    def SDL_GL_DestroyContext(context: Any, /) -> bool:
        """unsigned char SDL_GL_DestroyContext(SDL_GLContext context)"""

    @staticmethod
    def SDL_GL_ExtensionSupported(extension: Any, /) -> bool:
        """unsigned char SDL_GL_ExtensionSupported(const char *extension)"""

    @staticmethod
    def SDL_GL_GetAttribute(attr: Any, value: Any, /) -> bool:
        """unsigned char SDL_GL_GetAttribute(SDL_GLAttr attr, int *value)"""
    ...
    def SDL_GL_GetSwapInterval(interval: Any, /) -> bool:
        """unsigned char SDL_GL_GetSwapInterval(int *interval)"""

    @staticmethod
    def SDL_GL_LoadLibrary(path: Any, /) -> bool:
        """unsigned char SDL_GL_LoadLibrary(const char *path)"""

    @staticmethod
    def SDL_GL_MakeCurrent(window: Any, context: Any, /) -> bool:
        """unsigned char SDL_GL_MakeCurrent(SDL_Window *window, SDL_GLContext context)"""
    ...
    def SDL_GL_SetAttribute(attr: Any, value: int, /) -> bool:
        """unsigned char SDL_GL_SetAttribute(SDL_GLAttr attr, int value)"""

    @staticmethod
    def SDL_GL_SetSwapInterval(interval: int, /) -> bool:
        """unsigned char SDL_GL_SetSwapInterval(int interval)"""

    @staticmethod
    def SDL_GL_SwapWindow(window: Any, /) -> bool:
        """unsigned char SDL_GL_SwapWindow(SDL_Window *window)"""
    ...
    def SDL_GPUSupportsProperties(props: Any, /) -> bool:
        """unsigned char SDL_GPUSupportsProperties(SDL_PropertiesID props)"""

    @staticmethod
    def SDL_GPUSupportsShaderFormats(format_flags: Any, name: Any, /) -> bool:
        """unsigned char SDL_GPUSupportsShaderFormats(SDL_GPUShaderFormat format_flags, const char *name)"""
    ...
    def SDL_GPUTextureSupportsFormat(device: Any, format: Any, type: Any, usage: Any, /) -> bool:
        """unsigned char SDL_GPUTextureSupportsFormat(SDL_GPUDevice *device, SDL_GPUTextureFormat format, SDL_GPUTextureType type, SDL_GPUTextureUsageFlags usage)"""

    @staticmethod
    def SDL_GPUTextureSupportsSampleCount(device: Any, format: Any, sample_count: Any, /) -> bool:
        """unsigned char SDL_GPUTextureSupportsSampleCount(SDL_GPUDevice *device, SDL_GPUTextureFormat format, SDL_GPUSampleCount sample_count)"""
    ...
    def SDL_GamepadConnected(gamepad: Any, /) -> bool:
        """unsigned char SDL_GamepadConnected(SDL_Gamepad *gamepad)"""

    @staticmethod
    def SDL_GamepadEventsEnabled() -> bool:
        """unsigned char SDL_GamepadEventsEnabled(void)"""

    @staticmethod
    def SDL_GamepadHasAxis(gamepad: Any, axis: Any, /) -> bool:
        """unsigned char SDL_GamepadHasAxis(SDL_Gamepad *gamepad, SDL_GamepadAxis axis)"""

    @staticmethod
    def SDL_GamepadHasButton(gamepad: Any, button: Any, /) -> bool:
        """unsigned char SDL_GamepadHasButton(SDL_Gamepad *gamepad, SDL_GamepadButton button)"""

    @staticmethod
    def SDL_GamepadHasSensor(gamepad: Any, type: Any, /) -> bool:
        """unsigned char SDL_GamepadHasSensor(SDL_Gamepad *gamepad, SDL_SensorType type)"""

    @staticmethod
    def SDL_GamepadSensorEnabled(gamepad: Any, type: Any, /) -> bool:
        """unsigned char SDL_GamepadSensorEnabled(SDL_Gamepad *gamepad, SDL_SensorType type)"""
    ...
    def SDL_GetAsyncIOResult(queue: Any, outcome: Any, /) -> bool:
        """unsigned char SDL_GetAsyncIOResult(SDL_AsyncIOQueue *queue, SDL_AsyncIOOutcome *outcome)"""
    ...
    def SDL_GetAudioDeviceFormat(devid: Any, spec: Any, sample_frames: Any, /) -> bool:
        """unsigned char SDL_GetAudioDeviceFormat(SDL_AudioDeviceID devid, SDL_AudioSpec *spec, int *sample_frames)"""

    @staticmethod
    def SDL_GetAudioDeviceGain(devid: Any, /) -> Any:
    ...
    def SDL_GetAudioStreamFormat(stream: Any, src_spec: Any, dst_spec: Any, /) -> bool:
        """unsigned char SDL_GetAudioStreamFormat(SDL_AudioStream *stream, SDL_AudioSpec *src_spec, SDL_AudioSpec *dst_spec)"""

    @staticmethod
    def SDL_GetAudioStreamFrequencyRatio(stream: Any, /) -> Any:
        """float SDL_GetAudioStreamFrequencyRatio(SDL_AudioStream *stream)"""

    @staticmethod
    def SDL_GetAudioStreamGain(stream: Any, /) -> Any:
    ...
    def SDL_GetBooleanProperty(props: Any, name: Any, default_value: bool, /) -> bool:
        """unsigned char SDL_GetBooleanProperty(SDL_PropertiesID props, const char *name, unsigned char default_value)"""
    ...
    def SDL_GetCameraFormat(camera: Any, spec: Any, /) -> bool:
        """unsigned char SDL_GetCameraFormat(SDL_Camera *camera, SDL_CameraSpec *spec)"""
    ...
    def SDL_GetClosestFullscreenDisplayMode(
        displayID: Any, w: int, h: int, refresh_rate: Any, include_high_density_modes: bool, closest: Any, /
    ) -> bool:
        """unsigned char SDL_GetClosestFullscreenDisplayMode(SDL_DisplayID displayID, int w, int h, float refresh_rate, unsigned char include_high_density_modes, SDL_DisplayMode *closest)"""
    ...
    def SDL_GetCurrentRenderOutputSize(renderer: Any, w: Any, h: Any, /) -> bool:
        """unsigned char SDL_GetCurrentRenderOutputSize(SDL_Renderer *renderer, int *w, int *h)"""
    ...
    def SDL_GetCurrentTime(ticks: Any, /) -> bool:
        """unsigned char SDL_GetCurrentTime(SDL_Time *ticks)"""
    ...
    def SDL_GetDateTimeLocalePreferences(dateFormat: Any, timeFormat: Any, /) -> bool:
        """unsigned char SDL_GetDateTimeLocalePreferences(SDL_DateFormat *dateFormat, SDL_TimeFormat *timeFormat)"""
    ...
    def SDL_GetDisplayBounds(displayID: Any, rect: Any, /) -> bool:
        """unsigned char SDL_GetDisplayBounds(SDL_DisplayID displayID, SDL_Rect *rect)"""

    @staticmethod
    def SDL_GetDisplayContentScale(displayID: Any, /) -> Any:
    ...
    def SDL_GetDisplayUsableBounds(displayID: Any, rect: Any, /) -> bool:
        """unsigned char SDL_GetDisplayUsableBounds(SDL_DisplayID displayID, SDL_Rect *rect)"""
    ...
    def SDL_GetEventFilter(filter: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_GetEventFilter(SDL_EventFilter *filter, void **userdata)"""

    @staticmethod
    def SDL_GetFloatProperty(props: Any, name: Any, default_value: Any, /) -> Any:
    ...
    def SDL_GetGamepadButton(gamepad: Any, button: Any, /) -> bool:
        """unsigned char SDL_GetGamepadButton(SDL_Gamepad *gamepad, SDL_GamepadButton button)"""
    ...
    def SDL_GetGamepadSensorData(gamepad: Any, type: Any, data: Any, num_values: int, /) -> bool:
        """unsigned char SDL_GetGamepadSensorData(SDL_Gamepad *gamepad, SDL_SensorType type, float *data, int num_values)"""

    @staticmethod
    def SDL_GetGamepadSensorDataRate(gamepad: Any, type: Any, /) -> Any:
    ...
    def SDL_GetGamepadTouchpadFinger(
        ...
        """unsigned char SDL_GetGamepadTouchpadFinger(SDL_Gamepad *gamepad, int touchpad, int finger, unsigned char *down, float *x, float *y, float *pressure)"""
    ...
    def SDL_GetHapticEffectStatus(haptic: Any, effect: int, /) -> bool:
        """unsigned char SDL_GetHapticEffectStatus(SDL_Haptic *haptic, int effect)"""
    ...
    def SDL_GetHintBoolean(name: Any, default_value: bool, /) -> bool:
        """unsigned char SDL_GetHintBoolean(const char *name, unsigned char default_value)"""
    ...
    def SDL_GetJoystickAxisInitialState(joystick: Any, axis: int, state: Any, /) -> bool:
        """unsigned char SDL_GetJoystickAxisInitialState(SDL_Joystick *joystick, int axis, Sint16 *state)"""

    @staticmethod
    def SDL_GetJoystickBall(joystick: Any, ball: int, dx: Any, dy: Any, /) -> bool:
        """unsigned char SDL_GetJoystickBall(SDL_Joystick *joystick, int ball, int *dx, int *dy)"""

    @staticmethod
    def SDL_GetJoystickButton(joystick: Any, button: int, /) -> bool:
        """unsigned char SDL_GetJoystickButton(SDL_Joystick *joystick, int button)"""
    ...
    def SDL_GetKeyFromScancode(scancode: Any, modstate: Any, key_event: bool, /) -> Any:
        """SDL_Keycode SDL_GetKeyFromScancode(SDL_Scancode scancode, SDL_Keymod modstate, unsigned char key_event)"""
    ...
    def SDL_GetMasksForPixelFormat(format: Any, bpp: Any, Rmask: Any, Gmask: Any, Bmask: Any, Amask: Any, /) -> bool:
        """unsigned char SDL_GetMasksForPixelFormat(SDL_PixelFormat format, int *bpp, Uint32 *Rmask, Uint32 *Gmask, Uint32 *Bmask, Uint32 *Amask)"""
    ...
    def SDL_GetPathInfo(path: Any, info: Any, /) -> bool:
        """unsigned char SDL_GetPathInfo(const char *path, SDL_PathInfo *info)"""
    ...
    def SDL_GetRectAndLineIntersection(rect: Any, X1: Any, Y1: Any, X2: Any, Y2: Any, /) -> bool:
        """unsigned char SDL_GetRectAndLineIntersection(const SDL_Rect *rect, int *X1, int *Y1, int *X2, int *Y2)"""

    @staticmethod
    def SDL_GetRectAndLineIntersectionFloat(rect: Any, X1: Any, Y1: Any, X2: Any, Y2: Any, /) -> bool:
        """unsigned char SDL_GetRectAndLineIntersectionFloat(const SDL_FRect *rect, float *X1, float *Y1, float *X2, float *Y2)"""

    @staticmethod
    def SDL_GetRectEnclosingPoints(points: Any, count: int, clip: Any, result: Any, /) -> bool:
        """unsigned char SDL_GetRectEnclosingPoints(const SDL_Point *points, int count, const SDL_Rect *clip, SDL_Rect *result)"""

    @staticmethod
    def SDL_GetRectEnclosingPointsFloat(points: Any, count: int, clip: Any, result: Any, /) -> bool:
        """unsigned char SDL_GetRectEnclosingPointsFloat(const SDL_FPoint *points, int count, const SDL_FRect *clip, SDL_FRect *result)"""

    @staticmethod
    def SDL_GetRectIntersection(A: Any, B: Any, result: Any, /) -> bool:
        """unsigned char SDL_GetRectIntersection(const SDL_Rect *A, const SDL_Rect *B, SDL_Rect *result)"""

    @staticmethod
    def SDL_GetRectIntersectionFloat(A: Any, B: Any, result: Any, /) -> bool:
        """unsigned char SDL_GetRectIntersectionFloat(const SDL_FRect *A, const SDL_FRect *B, SDL_FRect *result)"""

    @staticmethod
    def SDL_GetRectUnion(A: Any, B: Any, result: Any, /) -> bool:
        """unsigned char SDL_GetRectUnion(const SDL_Rect *A, const SDL_Rect *B, SDL_Rect *result)"""

    @staticmethod
    def SDL_GetRectUnionFloat(A: Any, B: Any, result: Any, /) -> bool:
        """unsigned char SDL_GetRectUnionFloat(const SDL_FRect *A, const SDL_FRect *B, SDL_FRect *result)"""
    ...
    def SDL_GetRenderClipRect(renderer: Any, rect: Any, /) -> bool:
        """unsigned char SDL_GetRenderClipRect(SDL_Renderer *renderer, SDL_Rect *rect)"""

    @staticmethod
    def SDL_GetRenderColorScale(renderer: Any, scale: Any, /) -> bool:
        """unsigned char SDL_GetRenderColorScale(SDL_Renderer *renderer, float *scale)"""

    @staticmethod
    def SDL_GetRenderDrawBlendMode(renderer: Any, blendMode: Any, /) -> bool:
        """unsigned char SDL_GetRenderDrawBlendMode(SDL_Renderer *renderer, SDL_BlendMode *blendMode)"""

    @staticmethod
    def SDL_GetRenderDrawColor(renderer: Any, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_GetRenderDrawColor(SDL_Renderer *renderer, Uint8 *r, Uint8 *g, Uint8 *b, Uint8 *a)"""

    @staticmethod
    def SDL_GetRenderDrawColorFloat(renderer: Any, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_GetRenderDrawColorFloat(SDL_Renderer *renderer, float *r, float *g, float *b, float *a)"""
    ...
    def SDL_GetRenderLogicalPresentation(renderer: Any, w: Any, h: Any, mode: Any, /) -> bool:
        """unsigned char SDL_GetRenderLogicalPresentation(SDL_Renderer *renderer, int *w, int *h, SDL_RendererLogicalPresentation *mode)"""

    @staticmethod
    def SDL_GetRenderLogicalPresentationRect(renderer: Any, rect: Any, /) -> bool:
        """unsigned char SDL_GetRenderLogicalPresentationRect(SDL_Renderer *renderer, SDL_FRect *rect)"""
    ...
    def SDL_GetRenderOutputSize(renderer: Any, w: Any, h: Any, /) -> bool:
        """unsigned char SDL_GetRenderOutputSize(SDL_Renderer *renderer, int *w, int *h)"""

    @staticmethod
    def SDL_GetRenderSafeArea(renderer: Any, rect: Any, /) -> bool:
        """unsigned char SDL_GetRenderSafeArea(SDL_Renderer *renderer, SDL_Rect *rect)"""

    @staticmethod
    def SDL_GetRenderScale(renderer: Any, scaleX: Any, scaleY: Any, /) -> bool:
        """unsigned char SDL_GetRenderScale(SDL_Renderer *renderer, float *scaleX, float *scaleY)"""
    ...
    def SDL_GetRenderVSync(renderer: Any, vsync: Any, /) -> bool:
        """unsigned char SDL_GetRenderVSync(SDL_Renderer *renderer, int *vsync)"""

    @staticmethod
    def SDL_GetRenderViewport(renderer: Any, rect: Any, /) -> bool:
        """unsigned char SDL_GetRenderViewport(SDL_Renderer *renderer, SDL_Rect *rect)"""
    ...
    def SDL_GetSensorData(sensor: Any, data: Any, num_values: int, /) -> bool:
        """unsigned char SDL_GetSensorData(SDL_Sensor *sensor, float *data, int num_values)"""
    ...
    def SDL_GetStorageFileSize(storage: Any, path: Any, length: Any, /) -> bool:
        """unsigned char SDL_GetStorageFileSize(SDL_Storage *storage, const char *path, Uint64 *length)"""

    @staticmethod
    def SDL_GetStoragePathInfo(storage: Any, path: Any, info: Any, /) -> bool:
        """unsigned char SDL_GetStoragePathInfo(SDL_Storage *storage, const char *path, SDL_PathInfo *info)"""
    ...
    def SDL_GetSurfaceAlphaMod(surface: Any, alpha: Any, /) -> bool:
        """unsigned char SDL_GetSurfaceAlphaMod(SDL_Surface *surface, Uint8 *alpha)"""

    @staticmethod
    def SDL_GetSurfaceBlendMode(surface: Any, blendMode: Any, /) -> bool:
        """unsigned char SDL_GetSurfaceBlendMode(SDL_Surface *surface, SDL_BlendMode *blendMode)"""

    @staticmethod
    def SDL_GetSurfaceClipRect(surface: Any, rect: Any, /) -> bool:
        """unsigned char SDL_GetSurfaceClipRect(SDL_Surface *surface, SDL_Rect *rect)"""

    @staticmethod
    def SDL_GetSurfaceColorKey(surface: Any, key: Any, /) -> bool:
        """unsigned char SDL_GetSurfaceColorKey(SDL_Surface *surface, Uint32 *key)"""

    @staticmethod
    def SDL_GetSurfaceColorMod(surface: Any, r: Any, g: Any, b: Any, /) -> bool:
        """unsigned char SDL_GetSurfaceColorMod(SDL_Surface *surface, Uint8 *r, Uint8 *g, Uint8 *b)"""
    ...
    def SDL_GetTextInputArea(window: Any, rect: Any, cursor: Any, /) -> bool:
        """unsigned char SDL_GetTextInputArea(SDL_Window *window, SDL_Rect *rect, int *cursor)"""

    @staticmethod
    def SDL_GetTextureAlphaMod(texture: Any, alpha: Any, /) -> bool:
        """unsigned char SDL_GetTextureAlphaMod(SDL_Texture *texture, Uint8 *alpha)"""

    @staticmethod
    def SDL_GetTextureAlphaModFloat(texture: Any, alpha: Any, /) -> bool:
        """unsigned char SDL_GetTextureAlphaModFloat(SDL_Texture *texture, float *alpha)"""

    @staticmethod
    def SDL_GetTextureBlendMode(texture: Any, blendMode: Any, /) -> bool:
        """unsigned char SDL_GetTextureBlendMode(SDL_Texture *texture, SDL_BlendMode *blendMode)"""

    @staticmethod
    def SDL_GetTextureColorMod(texture: Any, r: Any, g: Any, b: Any, /) -> bool:
        """unsigned char SDL_GetTextureColorMod(SDL_Texture *texture, Uint8 *r, Uint8 *g, Uint8 *b)"""

    @staticmethod
    def SDL_GetTextureColorModFloat(texture: Any, r: Any, g: Any, b: Any, /) -> bool:
        """unsigned char SDL_GetTextureColorModFloat(SDL_Texture *texture, float *r, float *g, float *b)"""
    ...
    def SDL_GetTextureScaleMode(texture: Any, scaleMode: Any, /) -> bool:
        """unsigned char SDL_GetTextureScaleMode(SDL_Texture *texture, SDL_ScaleMode *scaleMode)"""

    @staticmethod
    def SDL_GetTextureSize(texture: Any, w: Any, h: Any, /) -> bool:
        """unsigned char SDL_GetTextureSize(SDL_Texture *texture, float *w, float *h)"""
    ...
    def SDL_GetTrayEntryChecked(entry: Any, /) -> bool:
        """unsigned char SDL_GetTrayEntryChecked(SDL_TrayEntry *entry)"""

    @staticmethod
    def SDL_GetTrayEntryEnabled(entry: Any, /) -> bool:
        """unsigned char SDL_GetTrayEntryEnabled(SDL_TrayEntry *entry)"""
    ...
    def SDL_GetWindowAspectRatio(window: Any, min_aspect: Any, max_aspect: Any, /) -> bool:
        """unsigned char SDL_GetWindowAspectRatio(SDL_Window *window, float *min_aspect, float *max_aspect)"""

    @staticmethod
    def SDL_GetWindowBordersSize(window: Any, top: Any, left: Any, bottom: Any, right: Any, /) -> bool:
        """unsigned char SDL_GetWindowBordersSize(SDL_Window *window, int *top, int *left, int *bottom, int *right)"""

    @staticmethod
    def SDL_GetWindowDisplayScale(window: Any, /) -> Any:
    ...
    def SDL_GetWindowKeyboardGrab(window: Any, /) -> bool:
        """unsigned char SDL_GetWindowKeyboardGrab(SDL_Window *window)"""

    @staticmethod
    def SDL_GetWindowMaximumSize(window: Any, w: Any, h: Any, /) -> bool:
        """unsigned char SDL_GetWindowMaximumSize(SDL_Window *window, int *w, int *h)"""

    @staticmethod
    def SDL_GetWindowMinimumSize(window: Any, w: Any, h: Any, /) -> bool:
        """unsigned char SDL_GetWindowMinimumSize(SDL_Window *window, int *w, int *h)"""

    @staticmethod
    def SDL_GetWindowMouseGrab(window: Any, /) -> bool:
        """unsigned char SDL_GetWindowMouseGrab(SDL_Window *window)"""
    ...
    @staticmethod
    def SDL_GetWindowOpacity(window: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_GetWindowPixelDensity(window: Any, /) -> Any:
    ...
    def SDL_GetWindowPosition(window: Any, x: Any, y: Any, /) -> bool:
        """unsigned char SDL_GetWindowPosition(SDL_Window *window, int *x, int *y)"""
    ...
    def SDL_GetWindowRelativeMouseMode(window: Any, /) -> bool:
        """unsigned char SDL_GetWindowRelativeMouseMode(SDL_Window *window)"""

    @staticmethod
    def SDL_GetWindowSafeArea(window: Any, rect: Any, /) -> bool:
        """unsigned char SDL_GetWindowSafeArea(SDL_Window *window, SDL_Rect *rect)"""

    @staticmethod
    def SDL_GetWindowSize(window: Any, w: Any, h: Any, /) -> bool:
        """unsigned char SDL_GetWindowSize(SDL_Window *window, int *w, int *h)"""

    @staticmethod
    def SDL_GetWindowSizeInPixels(window: Any, w: Any, h: Any, /) -> bool:
        """unsigned char SDL_GetWindowSizeInPixels(SDL_Window *window, int *w, int *h)"""
    ...
    def SDL_GetWindowSurfaceVSync(window: Any, vsync: Any, /) -> bool:
        """unsigned char SDL_GetWindowSurfaceVSync(SDL_Window *window, int *vsync)"""
    ...
    def SDL_HapticEffectSupported(haptic: Any, effect: Any, /) -> bool:
        """unsigned char SDL_HapticEffectSupported(SDL_Haptic *haptic, const SDL_HapticEffect *effect)"""

    @staticmethod
    def SDL_HapticRumbleSupported(haptic: Any, /) -> bool:
        """unsigned char SDL_HapticRumbleSupported(SDL_Haptic *haptic)"""

    @staticmethod
    def SDL_HasARMSIMD() -> bool:
        """unsigned char SDL_HasARMSIMD(void)"""

    @staticmethod
    def SDL_HasAVX() -> bool:
        """unsigned char SDL_HasAVX(void)"""

    @staticmethod
    def SDL_HasAVX2() -> bool:
        """unsigned char SDL_HasAVX2(void)"""

    @staticmethod
    def SDL_HasAVX512F() -> bool:
        """unsigned char SDL_HasAVX512F(void)"""

    @staticmethod
    def SDL_HasAltiVec() -> bool:
        """unsigned char SDL_HasAltiVec(void)"""

    @staticmethod
    def SDL_HasClipboardData(mime_type: Any, /) -> bool:
        """unsigned char SDL_HasClipboardData(const char *mime_type)"""

    @staticmethod
    def SDL_HasClipboardText() -> bool:
        """unsigned char SDL_HasClipboardText(void)"""

    @staticmethod
    def SDL_HasEvent(type: Any, /) -> bool:
        """unsigned char SDL_HasEvent(Uint32 type)"""

    @staticmethod
    def SDL_HasEvents(minType: Any, maxType: Any, /) -> bool:
        """unsigned char SDL_HasEvents(Uint32 minType, Uint32 maxType)"""

    @staticmethod
    def SDL_HasGamepad() -> bool:
        """unsigned char SDL_HasGamepad(void)"""

    @staticmethod
    def SDL_HasJoystick() -> bool:
        """unsigned char SDL_HasJoystick(void)"""

    @staticmethod
    def SDL_HasKeyboard() -> bool:
        """unsigned char SDL_HasKeyboard(void)"""

    @staticmethod
    def SDL_HasLASX() -> bool:
        """unsigned char SDL_HasLASX(void)"""

    @staticmethod
    def SDL_HasLSX() -> bool:
        """unsigned char SDL_HasLSX(void)"""

    @staticmethod
    def SDL_HasMMX() -> bool:
        """unsigned char SDL_HasMMX(void)"""

    @staticmethod
    def SDL_HasMouse() -> bool:
        """unsigned char SDL_HasMouse(void)"""

    @staticmethod
    def SDL_HasNEON() -> bool:
        """unsigned char SDL_HasNEON(void)"""

    @staticmethod
    def SDL_HasPrimarySelectionText() -> bool:
        """unsigned char SDL_HasPrimarySelectionText(void)"""

    @staticmethod
    def SDL_HasProperty(props: Any, name: Any, /) -> bool:
        """unsigned char SDL_HasProperty(SDL_PropertiesID props, const char *name)"""

    @staticmethod
    def SDL_HasRectIntersection(A: Any, B: Any, /) -> bool:
        """unsigned char SDL_HasRectIntersection(const SDL_Rect *A, const SDL_Rect *B)"""

    @staticmethod
    def SDL_HasRectIntersectionFloat(A: Any, B: Any, /) -> bool:
        """unsigned char SDL_HasRectIntersectionFloat(const SDL_FRect *A, const SDL_FRect *B)"""

    @staticmethod
    def SDL_HasSSE() -> bool:
        """unsigned char SDL_HasSSE(void)"""

    @staticmethod
    def SDL_HasSSE2() -> bool:
        """unsigned char SDL_HasSSE2(void)"""

    @staticmethod
    def SDL_HasSSE3() -> bool:
        """unsigned char SDL_HasSSE3(void)"""

    @staticmethod
    def SDL_HasSSE41() -> bool:
        """unsigned char SDL_HasSSE41(void)"""

    @staticmethod
    def SDL_HasSSE42() -> bool:
        """unsigned char SDL_HasSSE42(void)"""

    @staticmethod
    def SDL_HasScreenKeyboardSupport() -> bool:
        """unsigned char SDL_HasScreenKeyboardSupport(void)"""

    @staticmethod
    def SDL_HideCursor() -> bool:
        """unsigned char SDL_HideCursor(void)"""

    @staticmethod
    def SDL_HideWindow(window: Any, /) -> bool:
        """unsigned char SDL_HideWindow(SDL_Window *window)"""
    ...
    def SDL_Init(flags: Any, /) -> bool:
        """unsigned char SDL_Init(SDL_InitFlags flags)"""

    @staticmethod
    def SDL_InitHapticRumble(haptic: Any, /) -> bool:
        """unsigned char SDL_InitHapticRumble(SDL_Haptic *haptic)"""

    @staticmethod
    def SDL_InitSubSystem(flags: Any, /) -> bool:
        """unsigned char SDL_InitSubSystem(SDL_InitFlags flags)"""
    ...
    def SDL_IsAudioDevicePhysical(devid: Any, /) -> bool:
        """unsigned char SDL_IsAudioDevicePhysical(SDL_AudioDeviceID devid)"""

    @staticmethod
    def SDL_IsAudioDevicePlayback(devid: Any, /) -> bool:
        """unsigned char SDL_IsAudioDevicePlayback(SDL_AudioDeviceID devid)"""

    @staticmethod
    def SDL_IsGamepad(instance_id: Any, /) -> bool:
        """unsigned char SDL_IsGamepad(SDL_JoystickID instance_id)"""

    @staticmethod
    def SDL_IsJoystickHaptic(joystick: Any, /) -> bool:
        """unsigned char SDL_IsJoystickHaptic(SDL_Joystick *joystick)"""

    @staticmethod
    def SDL_IsJoystickVirtual(instance_id: Any, /) -> bool:
        """unsigned char SDL_IsJoystickVirtual(SDL_JoystickID instance_id)"""

    @staticmethod
    def SDL_IsMainThread() -> bool:
        """unsigned char SDL_IsMainThread(void)"""

    @staticmethod
    def SDL_IsMouseHaptic() -> bool:
        """unsigned char SDL_IsMouseHaptic(void)"""

    @staticmethod
    def SDL_IsTV() -> bool:
        """unsigned char SDL_IsTV(void)"""

    @staticmethod
    def SDL_IsTablet() -> bool:
        """unsigned char SDL_IsTablet(void)"""

    @staticmethod
    def SDL_JoystickConnected(joystick: Any, /) -> bool:
        """unsigned char SDL_JoystickConnected(SDL_Joystick *joystick)"""

    @staticmethod
    def SDL_JoystickEventsEnabled() -> bool:
        """unsigned char SDL_JoystickEventsEnabled(void)"""

    @staticmethod
    def SDL_KillProcess(process: Any, force: bool, /) -> bool:
        """unsigned char SDL_KillProcess(SDL_Process *process, unsigned char force)"""
    ...
    def SDL_LoadBMP_IO(src: Any, closeio: bool, /) -> Any:
        """SDL_Surface *SDL_LoadBMP_IO(SDL_IOStream *src, unsigned char closeio)"""
    ...
    def SDL_LoadFileAsync(file: Any, queue: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_LoadFileAsync(const char *file, SDL_AsyncIOQueue *queue, void *userdata)"""

    @staticmethod
    def SDL_LoadFile_IO(src: Any, datasize: Any, closeio: bool, /) -> Any:
        """void *SDL_LoadFile_IO(SDL_IOStream *src, size_t *datasize, unsigned char closeio)"""
    ...
    def SDL_LoadWAV(path: Any, spec: Any, audio_buf: Any, audio_len: Any, /) -> bool:
        """unsigned char SDL_LoadWAV(const char *path, SDL_AudioSpec *spec, Uint8 **audio_buf, Uint32 *audio_len)"""

    @staticmethod
    def SDL_LoadWAV_IO(src: Any, closeio: bool, spec: Any, audio_buf: Any, audio_len: Any, /) -> bool:
        """unsigned char SDL_LoadWAV_IO(SDL_IOStream *src, unsigned char closeio, SDL_AudioSpec *spec, Uint8 **audio_buf, Uint32 *audio_len)"""

    @staticmethod
    def SDL_LockAudioStream(stream: Any, /) -> bool:
        """unsigned char SDL_LockAudioStream(SDL_AudioStream *stream)"""
    ...
    def SDL_LockProperties(props: Any, /) -> bool:
        """unsigned char SDL_LockProperties(SDL_PropertiesID props)"""
    ...
    def SDL_LockSurface(surface: Any, /) -> bool:
        """unsigned char SDL_LockSurface(SDL_Surface *surface)"""

    @staticmethod
    def SDL_LockTexture(texture: Any, rect: Any, pixels: Any, pitch: Any, /) -> bool:
        """unsigned char SDL_LockTexture(SDL_Texture *texture, const SDL_Rect *rect, void **pixels, int *pitch)"""

    @staticmethod
    def SDL_LockTextureToSurface(texture: Any, rect: Any, surface: Any, /) -> bool:
        """unsigned char SDL_LockTextureToSurface(SDL_Texture *texture, const SDL_Rect *rect, SDL_Surface **surface)"""
    ...
    def SDL_MapGPUTransferBuffer(device: Any, transfer_buffer: Any, cycle: bool, /) -> Any:
        """void *SDL_MapGPUTransferBuffer(SDL_GPUDevice *device, SDL_GPUTransferBuffer *transfer_buffer, unsigned char cycle)"""
    ...
    def SDL_MaximizeWindow(window: Any, /) -> bool:
        """unsigned char SDL_MaximizeWindow(SDL_Window *window)"""
    ...
    def SDL_MinimizeWindow(window: Any, /) -> bool:
        """unsigned char SDL_MinimizeWindow(SDL_Window *window)"""

    @staticmethod
    def SDL_MixAudio(dst: Any, src: Any, format: Any, len: Any, volume: Any, /) -> bool:
        """unsigned char SDL_MixAudio(Uint8 *dst, const Uint8 *src, SDL_AudioFormat format, Uint32 len, float volume)"""
    ...
    def SDL_OpenURL(url: Any, /) -> bool:
        """unsigned char SDL_OpenURL(const char *url)"""
    ...
    def SDL_OutOfMemory() -> bool:
        """unsigned char SDL_OutOfMemory(void)"""

    @staticmethod
    def SDL_PauseAudioDevice(devid: Any, /) -> bool:
        """unsigned char SDL_PauseAudioDevice(SDL_AudioDeviceID devid)"""

    @staticmethod
    def SDL_PauseAudioStreamDevice(stream: Any, /) -> bool:
        """unsigned char SDL_PauseAudioStreamDevice(SDL_AudioStream *stream)"""

    @staticmethod
    def SDL_PauseHaptic(haptic: Any, /) -> bool:
        """unsigned char SDL_PauseHaptic(SDL_Haptic *haptic)"""
    ...
    @staticmethod
    def SDL_PlayHapticRumble(haptic: Any, strength: Any, length: Any, /) -> bool:
        """unsigned char SDL_PlayHapticRumble(SDL_Haptic *haptic, float strength, Uint32 length)"""
    ...
    def SDL_PremultiplyAlpha(
        ...
        """unsigned char SDL_PremultiplyAlpha(int width, int height, SDL_PixelFormat src_format, const void *src, int src_pitch, SDL_PixelFormat dst_format, void *dst, int dst_pitch, unsigned char linear)"""

    @staticmethod
    def SDL_PremultiplySurfaceAlpha(surface: Any, linear: bool, /) -> bool:
        """unsigned char SDL_PremultiplySurfaceAlpha(SDL_Surface *surface, unsigned char linear)"""
    ...
    def SDL_PushEvent(event: Any, /) -> bool:
        """unsigned char SDL_PushEvent(SDL_Event *event)"""
    ...
    def SDL_PutAudioStreamData(stream: Any, buf: Any, len: int, /) -> bool:
        """unsigned char SDL_PutAudioStreamData(SDL_AudioStream *stream, const void *buf, int len)"""

    @staticmethod
    def SDL_QueryGPUFence(device: Any, fence: Any, /) -> bool:
        """unsigned char SDL_QueryGPUFence(SDL_GPUDevice *device, SDL_GPUFence *fence)"""
    ...
    def SDL_RaiseWindow(window: Any, /) -> bool:
        """unsigned char SDL_RaiseWindow(SDL_Window *window)"""

    @staticmethod
    def SDL_ReadAsyncIO(asyncio: Any, ptr: Any, offset: Any, size: Any, queue: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_ReadAsyncIO(SDL_AsyncIO *asyncio, void *ptr, Uint64 offset, Uint64 size, SDL_AsyncIOQueue *queue, void *userdata)"""
    ...
    def SDL_ReadS16BE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadS16BE(SDL_IOStream *src, Sint16 *value)"""

    @staticmethod
    def SDL_ReadS16LE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadS16LE(SDL_IOStream *src, Sint16 *value)"""

    @staticmethod
    def SDL_ReadS32BE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadS32BE(SDL_IOStream *src, Sint32 *value)"""

    @staticmethod
    def SDL_ReadS32LE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadS32LE(SDL_IOStream *src, Sint32 *value)"""

    @staticmethod
    def SDL_ReadS64BE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadS64BE(SDL_IOStream *src, Sint64 *value)"""

    @staticmethod
    def SDL_ReadS64LE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadS64LE(SDL_IOStream *src, Sint64 *value)"""

    @staticmethod
    def SDL_ReadS8(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadS8(SDL_IOStream *src, Sint8 *value)"""

    @staticmethod
    def SDL_ReadStorageFile(storage: Any, path: Any, destination: Any, length: Any, /) -> bool:
        """unsigned char SDL_ReadStorageFile(SDL_Storage *storage, const char *path, void *destination, Uint64 length)"""

    @staticmethod
    def SDL_ReadSurfacePixel(surface: Any, x: int, y: int, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_ReadSurfacePixel(SDL_Surface *surface, int x, int y, Uint8 *r, Uint8 *g, Uint8 *b, Uint8 *a)"""

    @staticmethod
    def SDL_ReadSurfacePixelFloat(surface: Any, x: int, y: int, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_ReadSurfacePixelFloat(SDL_Surface *surface, int x, int y, float *r, float *g, float *b, float *a)"""

    @staticmethod
    def SDL_ReadU16BE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadU16BE(SDL_IOStream *src, Uint16 *value)"""

    @staticmethod
    def SDL_ReadU16LE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadU16LE(SDL_IOStream *src, Uint16 *value)"""

    @staticmethod
    def SDL_ReadU32BE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadU32BE(SDL_IOStream *src, Uint32 *value)"""

    @staticmethod
    def SDL_ReadU32LE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadU32LE(SDL_IOStream *src, Uint32 *value)"""

    @staticmethod
    def SDL_ReadU64BE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadU64BE(SDL_IOStream *src, Uint64 *value)"""

    @staticmethod
    def SDL_ReadU64LE(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadU64LE(SDL_IOStream *src, Uint64 *value)"""

    @staticmethod
    def SDL_ReadU8(src: Any, value: Any, /) -> bool:
        """unsigned char SDL_ReadU8(SDL_IOStream *src, Uint8 *value)"""
    ...
    def SDL_ReloadGamepadMappings() -> bool:
        """unsigned char SDL_ReloadGamepadMappings(void)"""
    ...
    def SDL_RemovePath(path: Any, /) -> bool:
        """unsigned char SDL_RemovePath(const char *path)"""

    @staticmethod
    def SDL_RemoveStoragePath(storage: Any, path: Any, /) -> bool:
        """unsigned char SDL_RemoveStoragePath(SDL_Storage *storage, const char *path)"""
    ...
    def SDL_RemoveTimer(id: Any, /) -> bool:
        """unsigned char SDL_RemoveTimer(SDL_TimerID id)"""
    ...
    def SDL_RenamePath(oldpath: Any, newpath: Any, /) -> bool:
        """unsigned char SDL_RenamePath(const char *oldpath, const char *newpath)"""

    @staticmethod
    def SDL_RenameStoragePath(storage: Any, oldpath: Any, newpath: Any, /) -> bool:
        """unsigned char SDL_RenameStoragePath(SDL_Storage *storage, const char *oldpath, const char *newpath)"""

    @staticmethod
    def SDL_RenderClear(renderer: Any, /) -> bool:
        """unsigned char SDL_RenderClear(SDL_Renderer *renderer)"""

    @staticmethod
    def SDL_RenderClipEnabled(renderer: Any, /) -> bool:
        """unsigned char SDL_RenderClipEnabled(SDL_Renderer *renderer)"""

    @staticmethod
    def SDL_RenderCoordinatesFromWindow(renderer: Any, window_x: Any, window_y: Any, x: Any, y: Any, /) -> bool:
        """unsigned char SDL_RenderCoordinatesFromWindow(SDL_Renderer *renderer, float window_x, float window_y, float *x, float *y)"""

    @staticmethod
    def SDL_RenderCoordinatesToWindow(renderer: Any, x: Any, y: Any, window_x: Any, window_y: Any, /) -> bool:
        """unsigned char SDL_RenderCoordinatesToWindow(SDL_Renderer *renderer, float x, float y, float *window_x, float *window_y)"""

    @staticmethod
    def SDL_RenderDebugText(renderer: Any, x: Any, y: Any, str: Any, /) -> bool:
        """unsigned char SDL_RenderDebugText(SDL_Renderer *renderer, float x, float y, const char *str)"""

    @staticmethod
    def SDL_RenderDebugTextFormat(renderer: Any, x: Any, y: Any, fmt: Any, /, *__args: Any) -> bool:
        """unsigned char SDL_RenderDebugTextFormat(SDL_Renderer *renderer, float x, float y, const char *fmt, ...)"""

    @staticmethod
    def SDL_RenderFillRect(renderer: Any, rect: Any, /) -> bool:
        """unsigned char SDL_RenderFillRect(SDL_Renderer *renderer, const SDL_FRect *rect)"""

    @staticmethod
    def SDL_RenderFillRects(renderer: Any, rects: Any, count: int, /) -> bool:
        """unsigned char SDL_RenderFillRects(SDL_Renderer *renderer, const SDL_FRect *rects, int count)"""

    @staticmethod
    def SDL_RenderGeometry(
        renderer: Any, texture: Any, vertices: Any, num_vertices: int, indices: Any, num_indices: int, /
    ) -> bool:
        """unsigned char SDL_RenderGeometry(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_Vertex *vertices, int num_vertices, const int *indices, int num_indices)"""
    ...
    def SDL_RenderGeometryRaw(
        ...
        """unsigned char SDL_RenderGeometryRaw(SDL_Renderer *renderer, SDL_Texture *texture, const float *xy, int xy_stride, const SDL_FColor *color, int color_stride, const float *uv, int uv_stride, int num_vertices, const void *indices, int num_indices, int size_indices)"""

    @staticmethod
    def SDL_RenderLine(renderer: Any, x1: Any, y1: Any, x2: Any, y2: Any, /) -> bool:
        """unsigned char SDL_RenderLine(SDL_Renderer *renderer, float x1, float y1, float x2, float y2)"""

    @staticmethod
    def SDL_RenderLines(renderer: Any, points: Any, count: int, /) -> bool:
        """unsigned char SDL_RenderLines(SDL_Renderer *renderer, const SDL_FPoint *points, int count)"""

    @staticmethod
    def SDL_RenderPoint(renderer: Any, x: Any, y: Any, /) -> bool:
        """unsigned char SDL_RenderPoint(SDL_Renderer *renderer, float x, float y)"""

    @staticmethod
    def SDL_RenderPoints(renderer: Any, points: Any, count: int, /) -> bool:
        """unsigned char SDL_RenderPoints(SDL_Renderer *renderer, const SDL_FPoint *points, int count)"""

    @staticmethod
    def SDL_RenderPresent(renderer: Any, /) -> bool:
        """unsigned char SDL_RenderPresent(SDL_Renderer *renderer)"""
    ...
    def SDL_RenderRect(renderer: Any, rect: Any, /) -> bool:
        """unsigned char SDL_RenderRect(SDL_Renderer *renderer, const SDL_FRect *rect)"""

    @staticmethod
    def SDL_RenderRects(renderer: Any, rects: Any, count: int, /) -> bool:
        """unsigned char SDL_RenderRects(SDL_Renderer *renderer, const SDL_FRect *rects, int count)"""

    @staticmethod
    def SDL_RenderTexture(renderer: Any, texture: Any, srcrect: Any, dstrect: Any, /) -> bool:
        """unsigned char SDL_RenderTexture(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, const SDL_FRect *dstrect)"""
    ...
    def SDL_RenderTexture9Grid(
        ...
        """unsigned char SDL_RenderTexture9Grid(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, float left_width, float right_width, float top_height, float bottom_height, float scale, const SDL_FRect *dstrect)"""

    @staticmethod
    def SDL_RenderTextureAffine(
        renderer: Any, texture: Any, srcrect: Any, origin: Any, right: Any, down: Any, /
    ) -> bool:
        """unsigned char SDL_RenderTextureAffine(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, const SDL_FPoint *origin, const SDL_FPoint *right, const SDL_FPoint *down)"""

    @staticmethod
    def SDL_RenderTextureRotated(
        renderer: Any, texture: Any, srcrect: Any, dstrect: Any, angle: Any, center: Any, flip: Any, /
    ) -> bool:
        """unsigned char SDL_RenderTextureRotated(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, const SDL_FRect *dstrect, double angle, const SDL_FPoint *center, SDL_FlipMode flip)"""

    @staticmethod
    def SDL_RenderTextureTiled(renderer: Any, texture: Any, srcrect: Any, scale: Any, dstrect: Any, /) -> bool:
        """unsigned char SDL_RenderTextureTiled(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, float scale, const SDL_FRect *dstrect)"""

    @staticmethod
    def SDL_RenderViewportSet(renderer: Any, /) -> bool:
        """unsigned char SDL_RenderViewportSet(SDL_Renderer *renderer)"""
    ...
    def SDL_ResetHint(name: Any, /) -> bool:
        """unsigned char SDL_ResetHint(const char *name)"""
    ...
    def SDL_RestoreWindow(window: Any, /) -> bool:
        """unsigned char SDL_RestoreWindow(SDL_Window *window)"""

    @staticmethod
    def SDL_ResumeAudioDevice(devid: Any, /) -> bool:
        """unsigned char SDL_ResumeAudioDevice(SDL_AudioDeviceID devid)"""

    @staticmethod
    def SDL_ResumeAudioStreamDevice(stream: Any, /) -> bool:
        """unsigned char SDL_ResumeAudioStreamDevice(SDL_AudioStream *stream)"""

    @staticmethod
    def SDL_ResumeHaptic(haptic: Any, /) -> bool:
        """unsigned char SDL_ResumeHaptic(SDL_Haptic *haptic)"""

    @staticmethod
    def SDL_RumbleGamepad(
        gamepad: Any, low_frequency_rumble: Any, high_frequency_rumble: Any, duration_ms: Any, /
    ) -> bool:
        """unsigned char SDL_RumbleGamepad(SDL_Gamepad *gamepad, Uint16 low_frequency_rumble, Uint16 high_frequency_rumble, Uint32 duration_ms)"""

    @staticmethod
    def SDL_RumbleGamepadTriggers(gamepad: Any, left_rumble: Any, right_rumble: Any, duration_ms: Any, /) -> bool:
        """unsigned char SDL_RumbleGamepadTriggers(SDL_Gamepad *gamepad, Uint16 left_rumble, Uint16 right_rumble, Uint32 duration_ms)"""

    @staticmethod
    def SDL_RumbleJoystick(
        joystick: Any, low_frequency_rumble: Any, high_frequency_rumble: Any, duration_ms: Any, /
    ) -> bool:
        """unsigned char SDL_RumbleJoystick(SDL_Joystick *joystick, Uint16 low_frequency_rumble, Uint16 high_frequency_rumble, Uint32 duration_ms)"""

    @staticmethod
    def SDL_RumbleJoystickTriggers(joystick: Any, left_rumble: Any, right_rumble: Any, duration_ms: Any, /) -> bool:
        """unsigned char SDL_RumbleJoystickTriggers(SDL_Joystick *joystick, Uint16 left_rumble, Uint16 right_rumble, Uint32 duration_ms)"""

    @staticmethod
    def SDL_RunHapticEffect(haptic: Any, effect: int, iterations: Any, /) -> bool:
        """unsigned char SDL_RunHapticEffect(SDL_Haptic *haptic, int effect, Uint32 iterations)"""

    @staticmethod
    def SDL_RunOnMainThread(callback: Any, userdata: Any, wait_complete: bool, /) -> bool:
        """unsigned char SDL_RunOnMainThread(SDL_MainThreadCallback callback, void *userdata, unsigned char wait_complete)"""

    @staticmethod
    def SDL_SaveBMP(surface: Any, file: Any, /) -> bool:
        """unsigned char SDL_SaveBMP(SDL_Surface *surface, const char *file)"""

    @staticmethod
    def SDL_SaveBMP_IO(surface: Any, dst: Any, closeio: bool, /) -> bool:
        """unsigned char SDL_SaveBMP_IO(SDL_Surface *surface, SDL_IOStream *dst, unsigned char closeio)"""

    @staticmethod
    def SDL_SaveFile(file: Any, data: Any, datasize: int, /) -> bool:
        """unsigned char SDL_SaveFile(const char *file, const void *data, size_t datasize)"""

    @staticmethod
    def SDL_SaveFile_IO(src: Any, data: Any, datasize: int, closeio: bool, /) -> bool:
        """unsigned char SDL_SaveFile_IO(SDL_IOStream *src, const void *data, size_t datasize, unsigned char closeio)"""
    ...
    def SDL_ScreenKeyboardShown(window: Any, /) -> bool:
        """unsigned char SDL_ScreenKeyboardShown(SDL_Window *window)"""

    @staticmethod
    def SDL_ScreenSaverEnabled() -> bool:
        """unsigned char SDL_ScreenSaverEnabled(void)"""
    ...
    def SDL_SendGamepadEffect(gamepad: Any, data: Any, size: int, /) -> bool:
        """unsigned char SDL_SendGamepadEffect(SDL_Gamepad *gamepad, const void *data, int size)"""

    @staticmethod
    def SDL_SendJoystickEffect(joystick: Any, data: Any, size: int, /) -> bool:
        """unsigned char SDL_SendJoystickEffect(SDL_Joystick *joystick, const void *data, int size)"""

    @staticmethod
    def SDL_SendJoystickVirtualSensorData(
        joystick: Any, type: Any, sensor_timestamp: Any, data: Any, num_values: int, /
    ) -> bool:
        """unsigned char SDL_SendJoystickVirtualSensorData(SDL_Joystick *joystick, SDL_SensorType type, Uint64 sensor_timestamp, const float *data, int num_values)"""

    @staticmethod
    def SDL_SetAppMetadata(appname: Any, appversion: Any, appidentifier: Any, /) -> bool:
        """unsigned char SDL_SetAppMetadata(const char *appname, const char *appversion, const char *appidentifier)"""

    @staticmethod
    def SDL_SetAppMetadataProperty(name: Any, value: Any, /) -> bool:
        """unsigned char SDL_SetAppMetadataProperty(const char *name, const char *value)"""
    ...
    @staticmethod
    def SDL_SetAudioDeviceGain(devid: Any, gain: Any, /) -> bool:
        """unsigned char SDL_SetAudioDeviceGain(SDL_AudioDeviceID devid, float gain)"""

    @staticmethod
    def SDL_SetAudioPostmixCallback(devid: Any, callback: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_SetAudioPostmixCallback(SDL_AudioDeviceID devid, SDL_AudioPostmixCallback callback, void *userdata)"""

    @staticmethod
    def SDL_SetAudioStreamFormat(stream: Any, src_spec: Any, dst_spec: Any, /) -> bool:
        """unsigned char SDL_SetAudioStreamFormat(SDL_AudioStream *stream, const SDL_AudioSpec *src_spec, const SDL_AudioSpec *dst_spec)"""

    @staticmethod
    def SDL_SetAudioStreamFrequencyRatio(stream: Any, ratio: Any, /) -> bool:
        """unsigned char SDL_SetAudioStreamFrequencyRatio(SDL_AudioStream *stream, float ratio)"""

    @staticmethod
    def SDL_SetAudioStreamGain(stream: Any, gain: Any, /) -> bool:
        """unsigned char SDL_SetAudioStreamGain(SDL_AudioStream *stream, float gain)"""

    @staticmethod
    def SDL_SetAudioStreamGetCallback(stream: Any, callback: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_SetAudioStreamGetCallback(SDL_AudioStream *stream, SDL_AudioStreamCallback callback, void *userdata)"""

    @staticmethod
    def SDL_SetAudioStreamInputChannelMap(stream: Any, chmap: Any, count: int, /) -> bool:
        """unsigned char SDL_SetAudioStreamInputChannelMap(SDL_AudioStream *stream, const int *chmap, int count)"""

    @staticmethod
    def SDL_SetAudioStreamOutputChannelMap(stream: Any, chmap: Any, count: int, /) -> bool:
        """unsigned char SDL_SetAudioStreamOutputChannelMap(SDL_AudioStream *stream, const int *chmap, int count)"""

    @staticmethod
    def SDL_SetAudioStreamPutCallback(stream: Any, callback: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_SetAudioStreamPutCallback(SDL_AudioStream *stream, SDL_AudioStreamCallback callback, void *userdata)"""

    @staticmethod
    def SDL_SetBooleanProperty(props: Any, name: Any, value: bool, /) -> bool:
        """unsigned char SDL_SetBooleanProperty(SDL_PropertiesID props, const char *name, unsigned char value)"""

    @staticmethod
    def SDL_SetClipboardData(
        callback: Any, cleanup: Any, userdata: Any, mime_types: Any, num_mime_types: int, /
    ) -> bool:
        """unsigned char SDL_SetClipboardData(SDL_ClipboardDataCallback callback, SDL_ClipboardCleanupCallback cleanup, void *userdata, const char **mime_types, size_t num_mime_types)"""

    @staticmethod
    def SDL_SetClipboardText(text: Any, /) -> bool:
        """unsigned char SDL_SetClipboardText(const char *text)"""

    @staticmethod
    def SDL_SetCurrentThreadPriority(priority: Any, /) -> bool:
        """unsigned char SDL_SetCurrentThreadPriority(SDL_ThreadPriority priority)"""

    @staticmethod
    def SDL_SetCursor(cursor: Any, /) -> bool:
        """unsigned char SDL_SetCursor(SDL_Cursor *cursor)"""

    @staticmethod
    def SDL_SetEnvironmentVariable(env: Any, name: Any, value: Any, overwrite: bool, /) -> bool:
        """unsigned char SDL_SetEnvironmentVariable(SDL_Environment *env, const char *name, const char *value, unsigned char overwrite)"""

    @staticmethod
    def SDL_SetError(fmt: Any, /, *__args: Any) -> bool:
        """unsigned char SDL_SetError(const char *fmt, ...)"""

    @staticmethod
    def SDL_SetEventEnabled(type: Any, enabled: bool, /) -> None:
        """void SDL_SetEventEnabled(Uint32 type, unsigned char enabled)"""
    ...
    @staticmethod
    def SDL_SetFloatProperty(props: Any, name: Any, value: Any, /) -> bool:
        """unsigned char SDL_SetFloatProperty(SDL_PropertiesID props, const char *name, float value)"""

    @staticmethod
    def SDL_SetGPUAllowedFramesInFlight(device: Any, allowed_frames_in_flight: Any, /) -> bool:
        """unsigned char SDL_SetGPUAllowedFramesInFlight(SDL_GPUDevice *device, Uint32 allowed_frames_in_flight)"""
    ...
    def SDL_SetGPUSwapchainParameters(
        ...
        """unsigned char SDL_SetGPUSwapchainParameters(SDL_GPUDevice *device, SDL_Window *window, SDL_GPUSwapchainComposition swapchain_composition, SDL_GPUPresentMode present_mode)"""
    ...
    def SDL_SetGamepadEventsEnabled(enabled: bool, /) -> None:
        """void SDL_SetGamepadEventsEnabled(unsigned char enabled)"""

    @staticmethod
    def SDL_SetGamepadLED(gamepad: Any, red: Any, green: Any, blue: Any, /) -> bool:
        """unsigned char SDL_SetGamepadLED(SDL_Gamepad *gamepad, Uint8 red, Uint8 green, Uint8 blue)"""

    @staticmethod
    def SDL_SetGamepadMapping(instance_id: Any, mapping: Any, /) -> bool:
        """unsigned char SDL_SetGamepadMapping(SDL_JoystickID instance_id, const char *mapping)"""

    @staticmethod
    def SDL_SetGamepadPlayerIndex(gamepad: Any, player_index: int, /) -> bool:
        """unsigned char SDL_SetGamepadPlayerIndex(SDL_Gamepad *gamepad, int player_index)"""

    @staticmethod
    def SDL_SetGamepadSensorEnabled(gamepad: Any, type: Any, enabled: bool, /) -> bool:
        """unsigned char SDL_SetGamepadSensorEnabled(SDL_Gamepad *gamepad, SDL_SensorType type, unsigned char enabled)"""

    @staticmethod
    def SDL_SetHapticAutocenter(haptic: Any, autocenter: int, /) -> bool:
        """unsigned char SDL_SetHapticAutocenter(SDL_Haptic *haptic, int autocenter)"""

    @staticmethod
    def SDL_SetHapticGain(haptic: Any, gain: int, /) -> bool:
        """unsigned char SDL_SetHapticGain(SDL_Haptic *haptic, int gain)"""

    @staticmethod
    def SDL_SetHint(name: Any, value: Any, /) -> bool:
        """unsigned char SDL_SetHint(const char *name, const char *value)"""

    @staticmethod
    def SDL_SetHintWithPriority(name: Any, value: Any, priority: Any, /) -> bool:
        """unsigned char SDL_SetHintWithPriority(const char *name, const char *value, SDL_HintPriority priority)"""

    @staticmethod
    def SDL_SetInitialized(state: Any, initialized: bool, /) -> None:
        """void SDL_SetInitialized(SDL_InitState *state, unsigned char initialized)"""

    @staticmethod
    def SDL_SetJoystickEventsEnabled(enabled: bool, /) -> None:
        """void SDL_SetJoystickEventsEnabled(unsigned char enabled)"""

    @staticmethod
    def SDL_SetJoystickLED(joystick: Any, red: Any, green: Any, blue: Any, /) -> bool:
        """unsigned char SDL_SetJoystickLED(SDL_Joystick *joystick, Uint8 red, Uint8 green, Uint8 blue)"""

    @staticmethod
    def SDL_SetJoystickPlayerIndex(joystick: Any, player_index: int, /) -> bool:
        """unsigned char SDL_SetJoystickPlayerIndex(SDL_Joystick *joystick, int player_index)"""

    @staticmethod
    def SDL_SetJoystickVirtualAxis(joystick: Any, axis: int, value: Any, /) -> bool:
        """unsigned char SDL_SetJoystickVirtualAxis(SDL_Joystick *joystick, int axis, Sint16 value)"""

    @staticmethod
    def SDL_SetJoystickVirtualBall(joystick: Any, ball: int, xrel: Any, yrel: Any, /) -> bool:
        """unsigned char SDL_SetJoystickVirtualBall(SDL_Joystick *joystick, int ball, Sint16 xrel, Sint16 yrel)"""

    @staticmethod
    def SDL_SetJoystickVirtualButton(joystick: Any, button: int, down: bool, /) -> bool:
        """unsigned char SDL_SetJoystickVirtualButton(SDL_Joystick *joystick, int button, unsigned char down)"""

    @staticmethod
    def SDL_SetJoystickVirtualHat(joystick: Any, hat: int, value: Any, /) -> bool:
        """unsigned char SDL_SetJoystickVirtualHat(SDL_Joystick *joystick, int hat, Uint8 value)"""

    @staticmethod
    def SDL_SetJoystickVirtualTouchpad(
        joystick: Any, touchpad: int, finger: int, down: bool, x: Any, y: Any, pressure: Any, /
    ) -> bool:
        """unsigned char SDL_SetJoystickVirtualTouchpad(SDL_Joystick *joystick, int touchpad, int finger, unsigned char down, float x, float y, float pressure)"""
    ...
    def SDL_SetLogPriorityPrefix(priority: Any, prefix: Any, /) -> bool:
        """unsigned char SDL_SetLogPriorityPrefix(SDL_LogPriority priority, const char *prefix)"""

    @staticmethod
    def SDL_SetMemoryFunctions(malloc_func: Any, calloc_func: Any, realloc_func: Any, free_func: Any, /) -> bool:
        """unsigned char SDL_SetMemoryFunctions(SDL_malloc_func malloc_func, SDL_calloc_func calloc_func, SDL_realloc_func realloc_func, SDL_free_func free_func)"""
    ...
    def SDL_SetNumberProperty(props: Any, name: Any, value: Any, /) -> bool:
        """unsigned char SDL_SetNumberProperty(SDL_PropertiesID props, const char *name, Sint64 value)"""

    @staticmethod
    def SDL_SetPaletteColors(palette: Any, colors: Any, firstcolor: int, ncolors: int, /) -> bool:
        """unsigned char SDL_SetPaletteColors(SDL_Palette *palette, const SDL_Color *colors, int firstcolor, int ncolors)"""

    @staticmethod
    def SDL_SetPointerProperty(props: Any, name: Any, value: Any, /) -> bool:
        """unsigned char SDL_SetPointerProperty(SDL_PropertiesID props, const char *name, void *value)"""

    @staticmethod
    def SDL_SetPointerPropertyWithCleanup(props: Any, name: Any, value: Any, cleanup: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_SetPointerPropertyWithCleanup(SDL_PropertiesID props, const char *name, void *value, SDL_CleanupPropertyCallback cleanup, void *userdata)"""

    @staticmethod
    def SDL_SetPrimarySelectionText(text: Any, /) -> bool:
        """unsigned char SDL_SetPrimarySelectionText(const char *text)"""

    @staticmethod
    def SDL_SetRenderClipRect(renderer: Any, rect: Any, /) -> bool:
        """unsigned char SDL_SetRenderClipRect(SDL_Renderer *renderer, const SDL_Rect *rect)"""

    @staticmethod
    def SDL_SetRenderColorScale(renderer: Any, scale: Any, /) -> bool:
        """unsigned char SDL_SetRenderColorScale(SDL_Renderer *renderer, float scale)"""

    @staticmethod
    def SDL_SetRenderDrawBlendMode(renderer: Any, blendMode: Any, /) -> bool:
        """unsigned char SDL_SetRenderDrawBlendMode(SDL_Renderer *renderer, SDL_BlendMode blendMode)"""

    @staticmethod
    def SDL_SetRenderDrawColor(renderer: Any, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_SetRenderDrawColor(SDL_Renderer *renderer, Uint8 r, Uint8 g, Uint8 b, Uint8 a)"""

    @staticmethod
    def SDL_SetRenderDrawColorFloat(renderer: Any, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_SetRenderDrawColorFloat(SDL_Renderer *renderer, float r, float g, float b, float a)"""

    @staticmethod
    def SDL_SetRenderLogicalPresentation(renderer: Any, w: int, h: int, mode: Any, /) -> bool:
        """unsigned char SDL_SetRenderLogicalPresentation(SDL_Renderer *renderer, int w, int h, SDL_RendererLogicalPresentation mode)"""

    @staticmethod
    def SDL_SetRenderScale(renderer: Any, scaleX: Any, scaleY: Any, /) -> bool:
        """unsigned char SDL_SetRenderScale(SDL_Renderer *renderer, float scaleX, float scaleY)"""

    @staticmethod
    def SDL_SetRenderTarget(renderer: Any, texture: Any, /) -> bool:
        """unsigned char SDL_SetRenderTarget(SDL_Renderer *renderer, SDL_Texture *texture)"""

    @staticmethod
    def SDL_SetRenderVSync(renderer: Any, vsync: int, /) -> bool:
        """unsigned char SDL_SetRenderVSync(SDL_Renderer *renderer, int vsync)"""

    @staticmethod
    def SDL_SetRenderViewport(renderer: Any, rect: Any, /) -> bool:
        """unsigned char SDL_SetRenderViewport(SDL_Renderer *renderer, const SDL_Rect *rect)"""

    @staticmethod
    def SDL_SetScancodeName(scancode: Any, name: Any, /) -> bool:
        """unsigned char SDL_SetScancodeName(SDL_Scancode scancode, const char *name)"""

    @staticmethod
    def SDL_SetStringProperty(props: Any, name: Any, value: Any, /) -> bool:
        """unsigned char SDL_SetStringProperty(SDL_PropertiesID props, const char *name, const char *value)"""

    @staticmethod
    def SDL_SetSurfaceAlphaMod(surface: Any, alpha: Any, /) -> bool:
        """unsigned char SDL_SetSurfaceAlphaMod(SDL_Surface *surface, Uint8 alpha)"""

    @staticmethod
    def SDL_SetSurfaceBlendMode(surface: Any, blendMode: Any, /) -> bool:
        """unsigned char SDL_SetSurfaceBlendMode(SDL_Surface *surface, SDL_BlendMode blendMode)"""

    @staticmethod
    def SDL_SetSurfaceClipRect(surface: Any, rect: Any, /) -> bool:
        """unsigned char SDL_SetSurfaceClipRect(SDL_Surface *surface, const SDL_Rect *rect)"""

    @staticmethod
    def SDL_SetSurfaceColorKey(surface: Any, enabled: bool, key: Any, /) -> bool:
        """unsigned char SDL_SetSurfaceColorKey(SDL_Surface *surface, unsigned char enabled, Uint32 key)"""

    @staticmethod
    def SDL_SetSurfaceColorMod(surface: Any, r: Any, g: Any, b: Any, /) -> bool:
        """unsigned char SDL_SetSurfaceColorMod(SDL_Surface *surface, Uint8 r, Uint8 g, Uint8 b)"""

    @staticmethod
    def SDL_SetSurfaceColorspace(surface: Any, colorspace: Any, /) -> bool:
        """unsigned char SDL_SetSurfaceColorspace(SDL_Surface *surface, SDL_Colorspace colorspace)"""

    @staticmethod
    def SDL_SetSurfacePalette(surface: Any, palette: Any, /) -> bool:
        """unsigned char SDL_SetSurfacePalette(SDL_Surface *surface, SDL_Palette *palette)"""

    @staticmethod
    def SDL_SetSurfaceRLE(surface: Any, enabled: bool, /) -> bool:
        """unsigned char SDL_SetSurfaceRLE(SDL_Surface *surface, unsigned char enabled)"""

    @staticmethod
    def SDL_SetTLS(id: Any, value: Any, destructor: Any, /) -> bool:
        """unsigned char SDL_SetTLS(SDL_TLSID *id, const void *value, SDL_TLSDestructorCallback destructor)"""

    @staticmethod
    def SDL_SetTextInputArea(window: Any, rect: Any, cursor: int, /) -> bool:
        """unsigned char SDL_SetTextInputArea(SDL_Window *window, const SDL_Rect *rect, int cursor)"""

    @staticmethod
    def SDL_SetTextureAlphaMod(texture: Any, alpha: Any, /) -> bool:
        """unsigned char SDL_SetTextureAlphaMod(SDL_Texture *texture, Uint8 alpha)"""

    @staticmethod
    def SDL_SetTextureAlphaModFloat(texture: Any, alpha: Any, /) -> bool:
        """unsigned char SDL_SetTextureAlphaModFloat(SDL_Texture *texture, float alpha)"""

    @staticmethod
    def SDL_SetTextureBlendMode(texture: Any, blendMode: Any, /) -> bool:
        """unsigned char SDL_SetTextureBlendMode(SDL_Texture *texture, SDL_BlendMode blendMode)"""

    @staticmethod
    def SDL_SetTextureColorMod(texture: Any, r: Any, g: Any, b: Any, /) -> bool:
        """unsigned char SDL_SetTextureColorMod(SDL_Texture *texture, Uint8 r, Uint8 g, Uint8 b)"""

    @staticmethod
    def SDL_SetTextureColorModFloat(texture: Any, r: Any, g: Any, b: Any, /) -> bool:
        """unsigned char SDL_SetTextureColorModFloat(SDL_Texture *texture, float r, float g, float b)"""

    @staticmethod
    def SDL_SetTextureScaleMode(texture: Any, scaleMode: Any, /) -> bool:
        """unsigned char SDL_SetTextureScaleMode(SDL_Texture *texture, SDL_ScaleMode scaleMode)"""
    ...
    def SDL_SetTrayEntryChecked(entry: Any, checked: bool, /) -> None:
        """void SDL_SetTrayEntryChecked(SDL_TrayEntry *entry, unsigned char checked)"""

    @staticmethod
    def SDL_SetTrayEntryEnabled(entry: Any, enabled: bool, /) -> None:
        """void SDL_SetTrayEntryEnabled(SDL_TrayEntry *entry, unsigned char enabled)"""
    ...
    def SDL_SetWindowAlwaysOnTop(window: Any, on_top: bool, /) -> bool:
        """unsigned char SDL_SetWindowAlwaysOnTop(SDL_Window *window, unsigned char on_top)"""

    @staticmethod
    def SDL_SetWindowAspectRatio(window: Any, min_aspect: Any, max_aspect: Any, /) -> bool:
        """unsigned char SDL_SetWindowAspectRatio(SDL_Window *window, float min_aspect, float max_aspect)"""

    @staticmethod
    def SDL_SetWindowBordered(window: Any, bordered: bool, /) -> bool:
        """unsigned char SDL_SetWindowBordered(SDL_Window *window, unsigned char bordered)"""

    @staticmethod
    def SDL_SetWindowFocusable(window: Any, focusable: bool, /) -> bool:
        """unsigned char SDL_SetWindowFocusable(SDL_Window *window, unsigned char focusable)"""

    @staticmethod
    def SDL_SetWindowFullscreen(window: Any, fullscreen: bool, /) -> bool:
        """unsigned char SDL_SetWindowFullscreen(SDL_Window *window, unsigned char fullscreen)"""

    @staticmethod
    def SDL_SetWindowFullscreenMode(window: Any, mode: Any, /) -> bool:
        """unsigned char SDL_SetWindowFullscreenMode(SDL_Window *window, const SDL_DisplayMode *mode)"""

    @staticmethod
    def SDL_SetWindowHitTest(window: Any, callback: Any, callback_data: Any, /) -> bool:
        """unsigned char SDL_SetWindowHitTest(SDL_Window *window, SDL_HitTest callback, void *callback_data)"""

    @staticmethod
    def SDL_SetWindowIcon(window: Any, icon: Any, /) -> bool:
        """unsigned char SDL_SetWindowIcon(SDL_Window *window, SDL_Surface *icon)"""

    @staticmethod
    def SDL_SetWindowKeyboardGrab(window: Any, grabbed: bool, /) -> bool:
        """unsigned char SDL_SetWindowKeyboardGrab(SDL_Window *window, unsigned char grabbed)"""

    @staticmethod
    def SDL_SetWindowMaximumSize(window: Any, max_w: int, max_h: int, /) -> bool:
        """unsigned char SDL_SetWindowMaximumSize(SDL_Window *window, int max_w, int max_h)"""

    @staticmethod
    def SDL_SetWindowMinimumSize(window: Any, min_w: int, min_h: int, /) -> bool:
        """unsigned char SDL_SetWindowMinimumSize(SDL_Window *window, int min_w, int min_h)"""

    @staticmethod
    def SDL_SetWindowModal(window: Any, modal: bool, /) -> bool:
        """unsigned char SDL_SetWindowModal(SDL_Window *window, unsigned char modal)"""

    @staticmethod
    def SDL_SetWindowMouseGrab(window: Any, grabbed: bool, /) -> bool:
        """unsigned char SDL_SetWindowMouseGrab(SDL_Window *window, unsigned char grabbed)"""

    @staticmethod
    def SDL_SetWindowMouseRect(window: Any, rect: Any, /) -> bool:
        """unsigned char SDL_SetWindowMouseRect(SDL_Window *window, const SDL_Rect *rect)"""

    @staticmethod
    def SDL_SetWindowOpacity(window: Any, opacity: Any, /) -> bool:
        """unsigned char SDL_SetWindowOpacity(SDL_Window *window, float opacity)"""

    @staticmethod
    def SDL_SetWindowParent(window: Any, parent: Any, /) -> bool:
        """unsigned char SDL_SetWindowParent(SDL_Window *window, SDL_Window *parent)"""

    @staticmethod
    def SDL_SetWindowPosition(window: Any, x: int, y: int, /) -> bool:
        """unsigned char SDL_SetWindowPosition(SDL_Window *window, int x, int y)"""

    @staticmethod
    def SDL_SetWindowRelativeMouseMode(window: Any, enabled: bool, /) -> bool:
        """unsigned char SDL_SetWindowRelativeMouseMode(SDL_Window *window, unsigned char enabled)"""

    @staticmethod
    def SDL_SetWindowResizable(window: Any, resizable: bool, /) -> bool:
        """unsigned char SDL_SetWindowResizable(SDL_Window *window, unsigned char resizable)"""

    @staticmethod
    def SDL_SetWindowShape(window: Any, shape: Any, /) -> bool:
        """unsigned char SDL_SetWindowShape(SDL_Window *window, SDL_Surface *shape)"""

    @staticmethod
    def SDL_SetWindowSize(window: Any, w: int, h: int, /) -> bool:
        """unsigned char SDL_SetWindowSize(SDL_Window *window, int w, int h)"""

    @staticmethod
    def SDL_SetWindowSurfaceVSync(window: Any, vsync: int, /) -> bool:
        """unsigned char SDL_SetWindowSurfaceVSync(SDL_Window *window, int vsync)"""

    @staticmethod
    def SDL_SetWindowTitle(window: Any, title: Any, /) -> bool:
        """unsigned char SDL_SetWindowTitle(SDL_Window *window, const char *title)"""
    ...
    def SDL_ShouldInit(state: Any, /) -> bool:
        """unsigned char SDL_ShouldInit(SDL_InitState *state)"""

    @staticmethod
    def SDL_ShouldQuit(state: Any, /) -> bool:
        """unsigned char SDL_ShouldQuit(SDL_InitState *state)"""

    @staticmethod
    def SDL_ShowCursor() -> bool:
        """unsigned char SDL_ShowCursor(void)"""
    ...
    def SDL_ShowMessageBox(messageboxdata: Any, buttonid: Any, /) -> bool:
        """unsigned char SDL_ShowMessageBox(const SDL_MessageBoxData *messageboxdata, int *buttonid)"""
    ...
    def SDL_ShowOpenFileDialog(
        ...
        """void SDL_ShowOpenFileDialog(SDL_DialogFileCallback callback, void *userdata, SDL_Window *window, const SDL_DialogFileFilter *filters, int nfilters, const char *default_location, unsigned char allow_many)"""

    @staticmethod
    def SDL_ShowOpenFolderDialog(
        callback: Any, userdata: Any, window: Any, default_location: Any, allow_many: bool, /
    ) -> None:
        """void SDL_ShowOpenFolderDialog(SDL_DialogFileCallback callback, void *userdata, SDL_Window *window, const char *default_location, unsigned char allow_many)"""
    ...
    def SDL_ShowSimpleMessageBox(flags: Any, title: Any, message: Any, window: Any, /) -> bool:
        """unsigned char SDL_ShowSimpleMessageBox(SDL_MessageBoxFlags flags, const char *title, const char *message, SDL_Window *window)"""

    @staticmethod
    def SDL_ShowWindow(window: Any, /) -> bool:
        """unsigned char SDL_ShowWindow(SDL_Window *window)"""

    @staticmethod
    def SDL_ShowWindowSystemMenu(window: Any, x: int, y: int, /) -> bool:
        """unsigned char SDL_ShowWindowSystemMenu(SDL_Window *window, int x, int y)"""
    ...
    def SDL_StartTextInput(window: Any, /) -> bool:
        """unsigned char SDL_StartTextInput(SDL_Window *window)"""

    @staticmethod
    def SDL_StartTextInputWithProperties(window: Any, props: Any, /) -> bool:
        """unsigned char SDL_StartTextInputWithProperties(SDL_Window *window, SDL_PropertiesID props)"""
    ...
    def SDL_StopHapticEffect(haptic: Any, effect: int, /) -> bool:
        """unsigned char SDL_StopHapticEffect(SDL_Haptic *haptic, int effect)"""

    @staticmethod
    def SDL_StopHapticEffects(haptic: Any, /) -> bool:
        """unsigned char SDL_StopHapticEffects(SDL_Haptic *haptic)"""

    @staticmethod
    def SDL_StopHapticRumble(haptic: Any, /) -> bool:
        """unsigned char SDL_StopHapticRumble(SDL_Haptic *haptic)"""

    @staticmethod
    def SDL_StopTextInput(window: Any, /) -> bool:
        """unsigned char SDL_StopTextInput(SDL_Window *window)"""

    @staticmethod
    def SDL_StorageReady(storage: Any, /) -> bool:
        """unsigned char SDL_StorageReady(SDL_Storage *storage)"""

    @staticmethod
    def SDL_StretchSurface(src: Any, srcrect: Any, dst: Any, dstrect: Any, scaleMode: Any, /) -> bool:
        """unsigned char SDL_StretchSurface(SDL_Surface *src, const SDL_Rect *srcrect, SDL_Surface *dst, const SDL_Rect *dstrect, SDL_ScaleMode scaleMode)"""
    ...
    def SDL_SubmitGPUCommandBuffer(command_buffer: Any, /) -> bool:
        """unsigned char SDL_SubmitGPUCommandBuffer(SDL_GPUCommandBuffer *command_buffer)"""
    ...
    def SDL_SurfaceHasAlternateImages(surface: Any, /) -> bool:
        """unsigned char SDL_SurfaceHasAlternateImages(SDL_Surface *surface)"""

    @staticmethod
    def SDL_SurfaceHasColorKey(surface: Any, /) -> bool:
        """unsigned char SDL_SurfaceHasColorKey(SDL_Surface *surface)"""

    @staticmethod
    def SDL_SurfaceHasRLE(surface: Any, /) -> bool:
        """unsigned char SDL_SurfaceHasRLE(SDL_Surface *surface)"""

    @staticmethod
    def SDL_SyncWindow(window: Any, /) -> bool:
        """unsigned char SDL_SyncWindow(SDL_Window *window)"""
    ...
    def SDL_TextInputActive(window: Any, /) -> bool:
        """unsigned char SDL_TextInputActive(SDL_Window *window)"""
    ...
    def SDL_TimeToDateTime(ticks: Any, dt: Any, localTime: bool, /) -> bool:
        """unsigned char SDL_TimeToDateTime(SDL_Time ticks, SDL_DateTime *dt, unsigned char localTime)"""
    ...
    def SDL_TryLockMutex(mutex: Any, /) -> bool:
        """unsigned char SDL_TryLockMutex(SDL_Mutex *mutex)"""

    @staticmethod
    def SDL_TryLockRWLockForReading(rwlock: Any, /) -> bool:
        """unsigned char SDL_TryLockRWLockForReading(SDL_RWLock *rwlock)"""

    @staticmethod
    def SDL_TryLockRWLockForWriting(rwlock: Any, /) -> bool:
        """unsigned char SDL_TryLockRWLockForWriting(SDL_RWLock *rwlock)"""

    @staticmethod
    def SDL_TryLockSpinlock(lock: Any, /) -> bool:
        """unsigned char SDL_TryLockSpinlock(SDL_SpinLock *lock)"""

    @staticmethod
    def SDL_TryWaitSemaphore(sem: Any, /) -> bool:
        """unsigned char SDL_TryWaitSemaphore(SDL_Semaphore *sem)"""
    ...
    def SDL_UnlockAudioStream(stream: Any, /) -> bool:
        """unsigned char SDL_UnlockAudioStream(SDL_AudioStream *stream)"""
    ...
    def SDL_UnsetEnvironmentVariable(env: Any, name: Any, /) -> bool:
        """unsigned char SDL_UnsetEnvironmentVariable(SDL_Environment *env, const char *name)"""
    ...
    def SDL_UpdateHapticEffect(haptic: Any, effect: int, data: Any, /) -> bool:
        """unsigned char SDL_UpdateHapticEffect(SDL_Haptic *haptic, int effect, const SDL_HapticEffect *data)"""
    ...
    def SDL_UpdateNVTexture(texture: Any, rect: Any, Yplane: Any, Ypitch: int, UVplane: Any, UVpitch: int, /) -> bool:
        """unsigned char SDL_UpdateNVTexture(SDL_Texture *texture, const SDL_Rect *rect, const Uint8 *Yplane, int Ypitch, const Uint8 *UVplane, int UVpitch)"""
    ...
    def SDL_UpdateTexture(texture: Any, rect: Any, pixels: Any, pitch: int, /) -> bool:
        """unsigned char SDL_UpdateTexture(SDL_Texture *texture, const SDL_Rect *rect, const void *pixels, int pitch)"""
    ...
    def SDL_UpdateWindowSurface(window: Any, /) -> bool:
        """unsigned char SDL_UpdateWindowSurface(SDL_Window *window)"""

    @staticmethod
    def SDL_UpdateWindowSurfaceRects(window: Any, rects: Any, numrects: int, /) -> bool:
        """unsigned char SDL_UpdateWindowSurfaceRects(SDL_Window *window, const SDL_Rect *rects, int numrects)"""

    @staticmethod
    def SDL_UpdateYUVTexture(
        texture: Any, rect: Any, Yplane: Any, Ypitch: int, Uplane: Any, Upitch: int, Vplane: Any, Vpitch: int, /
    ) -> bool:
        """unsigned char SDL_UpdateYUVTexture(SDL_Texture *texture, const SDL_Rect *rect, const Uint8 *Yplane, int Ypitch, const Uint8 *Uplane, int Upitch, const Uint8 *Vplane, int Vpitch)"""

    @staticmethod
    def SDL_UploadToGPUBuffer(copy_pass: Any, source: Any, destination: Any, cycle: bool, /) -> None:
        """void SDL_UploadToGPUBuffer(SDL_GPUCopyPass *copy_pass, const SDL_GPUTransferBufferLocation *source, const SDL_GPUBufferRegion *destination, unsigned char cycle)"""

    @staticmethod
    def SDL_UploadToGPUTexture(copy_pass: Any, source: Any, destination: Any, cycle: bool, /) -> None:
        """void SDL_UploadToGPUTexture(SDL_GPUCopyPass *copy_pass, const SDL_GPUTextureTransferInfo *source, const SDL_GPUTextureRegion *destination, unsigned char cycle)"""
    ...
    def SDL_WaitAndAcquireGPUSwapchainTexture(
        ...
        """unsigned char SDL_WaitAndAcquireGPUSwapchainTexture(SDL_GPUCommandBuffer *command_buffer, SDL_Window *window, SDL_GPUTexture **swapchain_texture, Uint32 *swapchain_texture_width, Uint32 *swapchain_texture_height)"""

    @staticmethod
    def SDL_WaitAsyncIOResult(queue: Any, outcome: Any, timeoutMS: Any, /) -> bool:
        """unsigned char SDL_WaitAsyncIOResult(SDL_AsyncIOQueue *queue, SDL_AsyncIOOutcome *outcome, Sint32 timeoutMS)"""
    ...
    def SDL_WaitConditionTimeout(cond: Any, mutex: Any, timeoutMS: Any, /) -> bool:
        """unsigned char SDL_WaitConditionTimeout(SDL_Condition *cond, SDL_Mutex *mutex, Sint32 timeoutMS)"""

    @staticmethod
    def SDL_WaitEvent(event: Any, /) -> bool:
        """unsigned char SDL_WaitEvent(SDL_Event *event)"""

    @staticmethod
    def SDL_WaitEventTimeout(event: Any, timeoutMS: Any, /) -> bool:
        """unsigned char SDL_WaitEventTimeout(SDL_Event *event, Sint32 timeoutMS)"""

    @staticmethod
    def SDL_WaitForGPUFences(device: Any, wait_all: bool, fences: Any, num_fences: Any, /) -> bool:
        """unsigned char SDL_WaitForGPUFences(SDL_GPUDevice *device, unsigned char wait_all, SDL_GPUFence * const *fences, Uint32 num_fences)"""

    @staticmethod
    def SDL_WaitForGPUIdle(device: Any, /) -> bool:
        """unsigned char SDL_WaitForGPUIdle(SDL_GPUDevice *device)"""

    @staticmethod
    def SDL_WaitForGPUSwapchain(device: Any, window: Any, /) -> bool:
        """unsigned char SDL_WaitForGPUSwapchain(SDL_GPUDevice *device, SDL_Window *window)"""

    @staticmethod
    def SDL_WaitProcess(process: Any, block: bool, exitcode: Any, /) -> bool:
        """unsigned char SDL_WaitProcess(SDL_Process *process, unsigned char block, int *exitcode)"""
    ...
    def SDL_WaitSemaphoreTimeout(sem: Any, timeoutMS: Any, /) -> bool:
        """unsigned char SDL_WaitSemaphoreTimeout(SDL_Semaphore *sem, Sint32 timeoutMS)"""
    ...
    @staticmethod
    def SDL_WarpMouseGlobal(x: Any, y: Any, /) -> bool:
        """unsigned char SDL_WarpMouseGlobal(float x, float y)"""

    @staticmethod
    def SDL_WarpMouseInWindow(window: Any, x: Any, y: Any, /) -> None:
    ...
    def SDL_WindowHasSurface(window: Any, /) -> bool:
        """unsigned char SDL_WindowHasSurface(SDL_Window *window)"""

    @staticmethod
    def SDL_WindowSupportsGPUPresentMode(device: Any, window: Any, present_mode: Any, /) -> bool:
        """unsigned char SDL_WindowSupportsGPUPresentMode(SDL_GPUDevice *device, SDL_Window *window, SDL_GPUPresentMode present_mode)"""

    @staticmethod
    def SDL_WindowSupportsGPUSwapchainComposition(device: Any, window: Any, swapchain_composition: Any, /) -> bool:
        """unsigned char SDL_WindowSupportsGPUSwapchainComposition(SDL_GPUDevice *device, SDL_Window *window, SDL_GPUSwapchainComposition swapchain_composition)"""

    @staticmethod
    def SDL_WriteAsyncIO(asyncio: Any, ptr: Any, offset: Any, size: Any, queue: Any, userdata: Any, /) -> bool:
        """unsigned char SDL_WriteAsyncIO(SDL_AsyncIO *asyncio, void *ptr, Uint64 offset, Uint64 size, SDL_AsyncIOQueue *queue, void *userdata)"""
    ...
    def SDL_WriteS16BE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteS16BE(SDL_IOStream *dst, Sint16 value)"""

    @staticmethod
    def SDL_WriteS16LE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteS16LE(SDL_IOStream *dst, Sint16 value)"""

    @staticmethod
    def SDL_WriteS32BE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteS32BE(SDL_IOStream *dst, Sint32 value)"""

    @staticmethod
    def SDL_WriteS32LE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteS32LE(SDL_IOStream *dst, Sint32 value)"""

    @staticmethod
    def SDL_WriteS64BE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteS64BE(SDL_IOStream *dst, Sint64 value)"""

    @staticmethod
    def SDL_WriteS64LE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteS64LE(SDL_IOStream *dst, Sint64 value)"""

    @staticmethod
    def SDL_WriteS8(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteS8(SDL_IOStream *dst, Sint8 value)"""

    @staticmethod
    def SDL_WriteStorageFile(storage: Any, path: Any, source: Any, length: Any, /) -> bool:
        """unsigned char SDL_WriteStorageFile(SDL_Storage *storage, const char *path, const void *source, Uint64 length)"""

    @staticmethod
    def SDL_WriteSurfacePixel(surface: Any, x: int, y: int, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_WriteSurfacePixel(SDL_Surface *surface, int x, int y, Uint8 r, Uint8 g, Uint8 b, Uint8 a)"""

    @staticmethod
    def SDL_WriteSurfacePixelFloat(surface: Any, x: int, y: int, r: Any, g: Any, b: Any, a: Any, /) -> bool:
        """unsigned char SDL_WriteSurfacePixelFloat(SDL_Surface *surface, int x, int y, float r, float g, float b, float a)"""

    @staticmethod
    def SDL_WriteU16BE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteU16BE(SDL_IOStream *dst, Uint16 value)"""

    @staticmethod
    def SDL_WriteU16LE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteU16LE(SDL_IOStream *dst, Uint16 value)"""

    @staticmethod
    def SDL_WriteU32BE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteU32BE(SDL_IOStream *dst, Uint32 value)"""

    @staticmethod
    def SDL_WriteU32LE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteU32LE(SDL_IOStream *dst, Uint32 value)"""

    @staticmethod
    def SDL_WriteU64BE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteU64BE(SDL_IOStream *dst, Uint64 value)"""

    @staticmethod
    def SDL_WriteU64LE(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteU64LE(SDL_IOStream *dst, Uint64 value)"""

    @staticmethod
    def SDL_WriteU8(dst: Any, value: Any, /) -> bool:
        """unsigned char SDL_WriteU8(SDL_IOStream *dst, Uint8 value)"""
    ...
    @staticmethod
    def SDL_acos(x: Any, /) -> Any:
        """double SDL_acos(double x)"""

    @staticmethod
    def SDL_acosf(x: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_asin(x: Any, /) -> Any:
        """double SDL_asin(double x)"""

    @staticmethod
    def SDL_asinf(x: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_atan(x: Any, /) -> Any:
        """double SDL_atan(double x)"""

    @staticmethod
    def SDL_atan2(y: Any, x: Any, /) -> Any:
        """double SDL_atan2(double y, double x)"""

    @staticmethod
    def SDL_atan2f(y: Any, x: Any, /) -> Any:
        """float SDL_atan2f(float y, float x)"""

    @staticmethod
    def SDL_atanf(x: Any, /) -> Any:
        """float SDL_atanf(float x)"""

    @staticmethod
    def SDL_atof(str: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_ceil(x: Any, /) -> Any:
        """double SDL_ceil(double x)"""

    @staticmethod
    def SDL_ceilf(x: Any, /) -> Any:
        """float SDL_ceilf(float x)"""

    @staticmethod
    def SDL_copysign(x: Any, y: Any, /) -> Any:
        """double SDL_copysign(double x, double y)"""

    @staticmethod
    def SDL_copysignf(x: Any, y: Any, /) -> Any:
        """float SDL_copysignf(float x, float y)"""

    @staticmethod
    def SDL_cos(x: Any, /) -> Any:
        """double SDL_cos(double x)"""

    @staticmethod
    def SDL_cosf(x: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_exp(x: Any, /) -> Any:
        """double SDL_exp(double x)"""

    @staticmethod
    def SDL_expf(x: Any, /) -> Any:
        """float SDL_expf(float x)"""

    @staticmethod
    def SDL_fabs(x: Any, /) -> Any:
        """double SDL_fabs(double x)"""

    @staticmethod
    def SDL_fabsf(x: Any, /) -> Any:
        """float SDL_fabsf(float x)"""

    @staticmethod
    def SDL_floor(x: Any, /) -> Any:
        """double SDL_floor(double x)"""

    @staticmethod
    def SDL_floorf(x: Any, /) -> Any:
        """float SDL_floorf(float x)"""

    @staticmethod
    def SDL_fmod(x: Any, y: Any, /) -> Any:
        """double SDL_fmod(double x, double y)"""

    @staticmethod
    def SDL_fmodf(x: Any, y: Any, /) -> Any:
    ...
    def SDL_hid_ble_scan(active: bool, /) -> None:
        """void SDL_hid_ble_scan(unsigned char active)"""
    ...
    @staticmethod
    def SDL_isinf(x: Any, /) -> int:
        """int SDL_isinf(double x)"""

    @staticmethod
    def SDL_isinff(x: Any, /) -> int:
    ...
    @staticmethod
    def SDL_isnan(x: Any, /) -> int:
        """int SDL_isnan(double x)"""

    @staticmethod
    def SDL_isnanf(x: Any, /) -> int:
    ...
    @staticmethod
    def SDL_log(x: Any, /) -> Any:
        """double SDL_log(double x)"""

    @staticmethod
    def SDL_log10(x: Any, /) -> Any:
        """double SDL_log10(double x)"""

    @staticmethod
    def SDL_log10f(x: Any, /) -> Any:
        """float SDL_log10f(float x)"""

    @staticmethod
    def SDL_logf(x: Any, /) -> Any:
        """float SDL_logf(float x)"""

    @staticmethod
    def SDL_lround(x: Any, /) -> Any:
        """long SDL_lround(double x)"""

    @staticmethod
    def SDL_lroundf(x: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_modf(x: Any, y: Any, /) -> Any:
        """double SDL_modf(double x, double *y)"""

    @staticmethod
    def SDL_modff(x: Any, y: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_pow(x: Any, y: Any, /) -> Any:
        """double SDL_pow(double x, double y)"""

    @staticmethod
    def SDL_powf(x: Any, y: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_round(x: Any, /) -> Any:
        """double SDL_round(double x)"""

    @staticmethod
    def SDL_roundf(x: Any, /) -> Any:
        """float SDL_roundf(float x)"""

    @staticmethod
    def SDL_scalbn(x: Any, n: int, /) -> Any:
        """double SDL_scalbn(double x, int n)"""

    @staticmethod
    def SDL_scalbnf(x: Any, n: int, /) -> Any:
    ...
    @staticmethod
    def SDL_sin(x: Any, /) -> Any:
        """double SDL_sin(double x)"""

    @staticmethod
    def SDL_sinf(x: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_sqrt(x: Any, /) -> Any:
        """double SDL_sqrt(double x)"""

    @staticmethod
    def SDL_sqrtf(x: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_strtod(str: Any, endp: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_tan(x: Any, /) -> Any:
        """double SDL_tan(double x)"""

    @staticmethod
    def SDL_tanf(x: Any, /) -> Any:
    ...
    @staticmethod
    def SDL_trunc(x: Any, /) -> Any:
        """double SDL_trunc(double x)"""

    @staticmethod
    def SDL_truncf(x: Any, /) -> Any:
    ...
    def TCOD_bsp_split_recursive(
        node: Any, randomizer: Any, nb: int, minHSize: int, minVSize: int, maxHRatio: Any, maxVRatio: Any, /
    ) -> None:
    ...
    @staticmethod
    def TCOD_color_HSV(hue: Any, saturation: Any, value: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_color_multiply_scalar(c1: Any, value: Any, /) -> Any:
        """TCOD_color_t TCOD_color_multiply_scalar(TCOD_color_t c1, float value)"""

    @staticmethod
    def TCOD_color_multiply_scalar_wrapper(c1: Any, value: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_color_scale_HSV(color: Any, saturation_coef: Any, value_coef: Any, /) -> None:
        """void TCOD_color_scale_HSV(TCOD_color_t *color, float saturation_coef, float value_coef)"""

    @staticmethod
    def TCOD_color_set_HSV(color: Any, hue: Any, saturation: Any, value: Any, /) -> None:
        """void TCOD_color_set_HSV(TCOD_color_t *color, float hue, float saturation, float value)"""

    @staticmethod
    def TCOD_color_set_hue(color: Any, hue: Any, /) -> None:
        """void TCOD_color_set_hue(TCOD_color_t *color, float hue)"""

    @staticmethod
    def TCOD_color_set_saturation(color: Any, saturation: Any, /) -> None:
        """void TCOD_color_set_saturation(TCOD_color_t *color, float saturation)"""

    @staticmethod
    def TCOD_color_set_value(color: Any, value: Any, /) -> None:
        """void TCOD_color_set_value(TCOD_color_t *color, float value)"""

    @staticmethod
    def TCOD_color_shift_hue(color: Any, shift: Any, /) -> None:
    ...
    def TCOD_console_blit(
        ...
        xDst: int,
        yDst: int,
        foreground_alpha: Any,
        background_alpha: Any,
        /,
    ) -> None:
    ...
    @staticmethod
    def TCOD_console_credits_render_ex(console: Any, x: int, y: int, alpha: bool, delta_time: Any, /) -> bool:
    ...
    @staticmethod
    def TCOD_context_recommended_console_size(context: Any, magnification: Any, columns: Any, rows: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_dijkstra_get_distance(dijkstra: Any, x: int, y: int, /) -> Any:
    ...
    @staticmethod
    def TCOD_dijkstra_new(map: Any, diagonalCost: Any, /) -> Any:
        """TCOD_Dijkstra *TCOD_dijkstra_new(TCOD_Map *map, float diagonalCost)"""

    @staticmethod
    def TCOD_dijkstra_new_using_function(
        map_width: int, map_height: int, func: Any, user_data: Any, diagonalCost: Any, /
    ) -> Any:
    ...
    @staticmethod
    def TCOD_heightmap_add(hm: Any, value: Any, /) -> None:
        """void TCOD_heightmap_add(TCOD_heightmap_t *hm, float value)"""

    @staticmethod
    def TCOD_heightmap_add_fbm(
        hm: Any, noise: Any, mul_x: Any, mul_y: Any, add_x: Any, add_y: Any, octaves: Any, delta: Any, scale: Any, /
    ) -> None:
    ...
    @staticmethod
    def TCOD_heightmap_add_hill(hm: Any, hx: Any, hy: Any, h_radius: Any, h_height: Any, /) -> None:
    ...
    @staticmethod
    def TCOD_heightmap_clamp(hm: Any, min: Any, max: Any, /) -> None:
    ...
    @staticmethod
    def TCOD_heightmap_count_cells(hm: Any, min: Any, max: Any, /) -> int:
    ...
    @staticmethod
    def TCOD_heightmap_dig_hill(hm: Any, hx: Any, hy: Any, h_radius: Any, h_height: Any, /) -> None:
        """void TCOD_heightmap_dig_hill(TCOD_heightmap_t *hm, float hx, float hy, float h_radius, float h_height)"""

    @staticmethod
    def TCOD_heightmap_get_interpolated_value(hm: Any, x: Any, y: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_heightmap_lerp_hm(hm1: Any, hm2: Any, out: Any, coef: Any, /) -> None:
        """void TCOD_heightmap_lerp_hm(const TCOD_heightmap_t *hm1, const TCOD_heightmap_t *hm2, TCOD_heightmap_t *out, float coef)"""

    @staticmethod
    def TCOD_heightmap_mid_point_displacement(hm: Any, rnd: Any, roughness: Any, /) -> None:
    ...
    @staticmethod
    def TCOD_heightmap_normalize(hm: Any, min: Any, max: Any, /) -> None:
        """void TCOD_heightmap_normalize(TCOD_heightmap_t *hm, float min, float max)"""

    @staticmethod
    def TCOD_heightmap_rain_erosion(
        hm: Any, nbDrops: int, erosionCoef: Any, sedimentationCoef: Any, rnd: Any, /
    ) -> None:
    ...
    @staticmethod
    def TCOD_heightmap_scale(hm: Any, value: Any, /) -> None:
    ...
    @staticmethod
    def TCOD_heightmap_set_value(hm: Any, x: int, y: int, value: Any, /) -> None:
        """void TCOD_heightmap_set_value(TCOD_heightmap_t *hm, int x, int y, float value)"""

    @staticmethod
    def TCOD_image_blit(
        image: Any, console: Any, x: Any, y: Any, bkgnd_flag: Any, scale_x: Any, scale_y: Any, angle: Any, /
    ) -> None:
    ...
    @staticmethod
    def TCOD_image_get_mipmap_pixel(image: Any, x0: Any, y0: Any, x1: Any, y1: Any, /) -> Any:
        """TCOD_color_t TCOD_image_get_mipmap_pixel(TCOD_Image *image, float x0, float y0, float x1, float y1)"""

    @staticmethod
    def TCOD_image_get_mipmap_pixel_wrapper(image: Any, x0: Any, y0: Any, x1: Any, y1: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_noise_get(noise: Any, f: Any, /) -> Any:
        """float TCOD_noise_get(TCOD_Noise *noise, const float *f)"""

    @staticmethod
    def TCOD_noise_get_ex(noise: Any, f: Any, type: Any, /) -> Any:
        """float TCOD_noise_get_ex(TCOD_Noise *noise, const float *f, TCOD_noise_type_t type)"""

    @staticmethod
    def TCOD_noise_get_fbm(noise: Any, f: Any, octaves: Any, /) -> Any:
        """float TCOD_noise_get_fbm(TCOD_Noise *noise, const float *f, float octaves)"""

    @staticmethod
    def TCOD_noise_get_fbm_ex(noise: Any, f: Any, octaves: Any, type: Any, /) -> Any:
    ...
    def TCOD_noise_get_fbm_vectorized(
        noise: Any, type: Any, octaves: Any, n: int, x: Any, y: Any, z: Any, w: Any, out: Any, /
    ) -> None:
    ...
    @staticmethod
    def TCOD_noise_get_turbulence(noise: Any, f: Any, octaves: Any, /) -> Any:
        """float TCOD_noise_get_turbulence(TCOD_Noise *noise, const float *f, float octaves)"""

    @staticmethod
    def TCOD_noise_get_turbulence_ex(noise: Any, f: Any, octaves: Any, type: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_noise_new(dimensions: int, hurst: Any, lacunarity: Any, random: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_parser_get_float_property(parser: Any, name: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_path_new_using_map(map: Any, diagonalCost: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_sys_elapsed_seconds() -> Any:
    ...
    @staticmethod
    def TCOD_sys_get_last_frame_length() -> Any:
    ...
    @staticmethod
    def TCOD_text_set_colors(txt: Any, fore: Any, back: Any, back_transparency: Any, /) -> None:
    ...
    @staticmethod
    def TCOD_zip_get_float(zip: Any, /) -> Any:
    ...
    @staticmethod
    def TCOD_zip_put_float(zip: Any, val: Any, /) -> None:
    ...
    @staticmethod
    def TDL_color_HSV(h: Any, s: Any, v: Any, /) -> int:
    ...
    @staticmethod
    def TDL_color_get_hue(color: int, /) -> Any:
        """float TDL_color_get_hue(int color)"""

    @staticmethod
    def TDL_color_get_saturation(color: int, /) -> Any:
        """float TDL_color_get_saturation(int color)"""

    @staticmethod
    def TDL_color_get_value(color: int, /) -> Any:
    ...
    @staticmethod
    def TDL_color_lerp(c1: int, c2: int, coef: Any, /) -> int:
    ...
    @staticmethod
    def TDL_color_multiply_scalar(c: int, value: Any, /) -> int:
        """int TDL_color_multiply_scalar(int c, float value)"""

    @staticmethod
    def TDL_color_scale_HSV(color: int, scoef: Any, vcoef: Any, /) -> int:
        """int TDL_color_scale_HSV(int color, float scoef, float vcoef)"""

    @staticmethod
    def TDL_color_set_hue(color: int, h: Any, /) -> int:
        """int TDL_color_set_hue(int color, float h)"""

    @staticmethod
    def TDL_color_set_saturation(color: int, h: Any, /) -> int:
        """int TDL_color_set_saturation(int color, float h)"""

    @staticmethod
    def TDL_color_set_value(color: int, h: Any, /) -> int:
        """int TDL_color_set_value(int color, float h)"""

    @staticmethod
    def TDL_color_shift_hue(color: int, hue_shift: Any, /) -> int:
    ...
    @staticmethod
    def TDL_list_get_float(l: Any, idx: int, /) -> Any:
    ...
    @staticmethod
    def _pycall_path_dest_only(x1: int, y1: int, x2: int, y2: int, user_data: Any, /) -> Any:
        """float _pycall_path_dest_only(int x1, int y1, int x2, int y2, void *user_data)"""

    @staticmethod
    def _pycall_path_old(x: int, y: int, xDest: int, yDest: int, user_data: Any, /) -> Any:
        """float _pycall_path_old(int x, int y, int xDest, int yDest, void *user_data)"""

    @staticmethod
    def _pycall_path_simple(x: int, y: int, xDest: int, yDest: int, user_data: Any, /) -> Any:
        """float _pycall_path_simple(int x, int y, int xDest, int yDest, void *user_data)"""

    @staticmethod
    def _pycall_path_swap_src_dest(x1: int, y1: int, x2: int, y2: int, user_data: Any, /) -> Any:
    ...
    def get_travel_path(ndim: Any, travel_map: Any, start: Any, out: Any, /) -> int:
        """ptrdiff_t get_travel_path(int8_t ndim, const struct NArray *travel_map, const int *start, int *out)"""
    ...
    def rebuild_frontier_from_distance(frontier: Any, dist_map: Any, /) -> int:
        """int rebuild_frontier_from_distance(struct TCOD_Frontier *frontier, const struct NArray *dist_map)"""
