...
class Joystick:
    ...
    def __init__(self, sdl_joystick_p: Any) -> None:  # noqa: ANN401
        ...
        self.axes: Final[int] = _check(lib.SDL_GetNumJoystickAxes(self.sdl_joystick_p))
        """The total number of axes."""
        self.balls: Final[int] = _check(lib.SDL_GetNumJoystickBalls(self.sdl_joystick_p))
        """The total number of trackballs."""
        self.buttons: Final[int] = _check(lib.SDL_GetNumJoystickButtons(self.sdl_joystick_p))
        """The total number of buttons."""
        self.hats: Final[int] = _check(lib.SDL_GetNumJoystickHats(self.sdl_joystick_p))
